...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7eff1075efe0>
...
.. parsed-literal::
    ...
    CPU times: user 315 ms, sys: 4.11 ms, total: 319 ms
    Wall time: 318 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7eff0ee2b6a0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 119 ms, sys: 683 µs, total: 119 ms
    Wall time: 119 ms
