...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f333abb3b20>
...
.. parsed-literal::
    ...
    CPU times: user 306 ms, sys: 521 µs, total: 306 ms
    Wall time: 305 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f33368745e0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 103 ms, sys: 7.36 ms, total: 110 ms
    Wall time: 110 ms
