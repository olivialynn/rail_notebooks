...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc3f9a4bd00>
...
.. parsed-literal::
    ...
    CPU times: user 352 ms, sys: 4.04 ms, total: 356 ms
    Wall time: 354 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc4511ebcd0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 120 ms, sys: 4.02 ms, total: 124 ms
    Wall time: 124 ms
