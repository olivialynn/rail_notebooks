...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc17cb384c0>
...
.. parsed-literal::
    ...
    CPU times: user 299 ms, sys: 8.05 ms, total: 307 ms
    Wall time: 306 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc122a886d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 107 ms, sys: 3.57 ms, total: 111 ms
    Wall time: 110 ms
