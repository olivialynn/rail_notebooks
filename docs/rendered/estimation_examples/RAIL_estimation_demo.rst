...
.. parsed-literal::
    ...
    CPU times: user 8.45 s, sys: 2.07 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5d047cf580>
...
.. parsed-literal::
    ...
    CPU times: user 47.9 s, sys: 10.6 s, total: 58.6 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5d0423a980>
