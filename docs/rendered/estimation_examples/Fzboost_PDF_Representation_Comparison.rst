...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:03:00] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:03:01] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4384b16350>
...
.. parsed-literal::
    ...
    CPU times: user 494 ms, sys: 106 ms, total: 600 ms
    Wall time: 1.3 s
...
.. parsed-literal::
    ...
    CPU times: user 8.91 s, sys: 296 ms, total: 9.21 s
    Wall time: 8.86 s
...
.. parsed-literal::
    ...
    CPU times: user 11.2 s, sys: 339 ms, total: 11.5 s
    Wall time: 11.1 s
...
.. parsed-literal::
    ...
    8.23 s ± 27 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    865 ms ± 16.4 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 354 ms, sys: 83.5 ms, total: 437 ms
    Wall time: 437 ms
...
.. parsed-literal::
    ...
    40.4 ms ± 499 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
