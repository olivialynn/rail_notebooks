...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f24859c7dc0>
...
.. parsed-literal::
    ...
    CPU times: user 294 ms, sys: 4.93 ms, total: 299 ms
    Wall time: 298 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f248415c700>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 5.93 ms, total: 128 ms
    Wall time: 128 ms
