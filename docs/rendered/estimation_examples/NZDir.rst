...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3b4d7a1960>
...
.. parsed-literal::
    ...
    CPU times: user 373 ms, sys: 12.7 ms, total: 386 ms
    Wall time: 385 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3b49851e10>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 136 ms, sys: 8.06 ms, total: 144 ms
    Wall time: 143 ms
