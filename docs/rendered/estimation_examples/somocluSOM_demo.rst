...
.. parsed-literal::
    ...
    CPU times: user 8min 18s, sys: 783 ms, total: 8min 19s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fabddc7b310>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7288/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fab73d27e80>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fab73dfc370>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fab73f36470>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fab73f18040>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7288/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fab7dc47c70>
