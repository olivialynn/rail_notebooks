...
.. parsed-literal::
    ...
    CPU times: user 8min 3s, sys: 886 ms, total: 8min 4s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9128b39d80>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f90c3838df0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f90cdfdc0d0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f90ce19e7a0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f90ce19eaa0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_16019/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f90c358d750>
