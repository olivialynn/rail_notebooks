...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:05:31] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:05:32] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:05:33] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:25] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:26] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:27] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 47.8 s, sys: 10.6 s, total: 58.4 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fad2cb22890>
...
.. parsed-literal::
    ...
    CPU times: user 525 ms, sys: 86.3 ms, total: 611 ms
    Wall time: 1.32 s
...
.. parsed-literal::
    ...
    CPU times: user 8.71 s, sys: 311 ms, total: 9.02 s
    Wall time: 8.67 s
...
.. parsed-literal::
    ...
    CPU times: user 10.8 s, sys: 329 ms, total: 11.2 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    8.1 s ± 31.9 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.4 s, sys: 994 ms, total: 12.4 s
    Wall time: 12.1 s
...
.. parsed-literal::
    ...
    821 ms ± 2.92 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 356 ms, sys: 80.1 ms, total: 436 ms
    Wall time: 436 ms
...
.. parsed-literal::
    ...
    40.2 ms ± 487 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
