...
`Evaluation_by_Type.ipynb <https://github.com/LSSTDESC/rail/blob/main/interactive_examples/evaluation_examples/Evaluation_by_Type.ipynb>`__
...
.. parsed-literal::
    ...
    (({'point_to_point': <Job point_to_point>},
      [<rail.evaluation.point_to_point_evaluator.PointToPointEvaluator at 0x7f8722718d90>]),
...
.. code:: ipython3
    ...
    ensemble_d = QPHandle("pdfs_data_2",path=pdfs_file)
    
    ztrue_data_d = QPOrTableHandle("ztrue_data_2", path=ztrue_file)
...
.. parsed-literal::
    ...
    OrderedDict([('point_stats_ez_zmode_redshift',
                  array([-0.02252694, -0.0214079 , -0.04232273, ..., -0.00522614,
...
.. parsed-literal::
    ...
    {'cdeloss_redshift': array([-6.75181317]),
     'point_stats_iqr_zmode_redshift': array([0.02091227])}
