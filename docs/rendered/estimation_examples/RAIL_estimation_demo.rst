...
.. parsed-literal::
    ...
    CPU times: user 13.2 s, sys: 4.71 s, total: 17.9 s
    Wall time: 17.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9f8997be50>
...
.. parsed-literal::
    ...
    CPU times: user 57.3 s, sys: 2.29 s, total: 59.6 s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9f882b2590>
