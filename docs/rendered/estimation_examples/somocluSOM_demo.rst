...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 830 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc20486e260>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7259/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc1a89c39d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc1a89a8580>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc1a89123b0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc1a89134f0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7259/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc1aae8fc40>
