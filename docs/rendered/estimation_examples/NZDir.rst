...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f704d5def80>
...
.. parsed-literal::
    ...
    CPU times: user 301 ms, sys: 12.4 ms, total: 313 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f70497524d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 103 ms, sys: 14.7 ms, total: 118 ms
    Wall time: 118 ms
