...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdaabdf7640>
...
.. parsed-literal::
    ...
    CPU times: user 317 ms, sys: 4.06 ms, total: 321 ms
    Wall time: 320 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdaa8006b30>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 12.5 ms, total: 123 ms
    Wall time: 122 ms
