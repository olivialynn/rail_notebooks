...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f629170ffa0>
...
.. parsed-literal::
    ...
    CPU times: user 292 ms, sys: 2.11 ms, total: 294 ms
    Wall time: 294 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f62901ffbe0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 960 μs, total: 127 ms
    Wall time: 126 ms
