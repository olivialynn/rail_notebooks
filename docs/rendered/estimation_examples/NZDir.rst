...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f47b671bd90>
...
.. parsed-literal::
    ...
    CPU times: user 319 ms, sys: 71 μs, total: 319 ms
    Wall time: 320 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f47b4e259f0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 121 ms, sys: 215 μs, total: 121 ms
    Wall time: 120 ms
