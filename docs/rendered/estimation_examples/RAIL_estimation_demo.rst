...
.. parsed-literal::
    ...
    CPU times: user 8.4 s, sys: 1.96 s, total: 10.4 s
    Wall time: 10.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff1d0b52e90>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff1d0b2f9d0>
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 953 ms, total: 12.7 s
    Wall time: 12.3 s
