...
.. parsed-literal::
    ...
    CPU times: user 8.56 s, sys: 1.89 s, total: 10.5 s
    Wall time: 10.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa3423c6620>
...
.. parsed-literal::
    ...
    CPU times: user 47.4 s, sys: 10.5 s, total: 57.9 s
    Wall time: 60 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa2fa9bdab0>
