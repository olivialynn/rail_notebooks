...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 592 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff59c5cdc60>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7726/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff5883d4b50>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff5883d51b0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff5882a0280>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff5882a1f60>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7726/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff58833e050>
