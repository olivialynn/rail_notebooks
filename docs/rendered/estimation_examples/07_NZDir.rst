...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe7f7b17670>
...
.. parsed-literal::
    ...
    CPU times: user 352 ms, sys: 6.99 ms, total: 359 ms
    Wall time: 358 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe7f7b175b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 121 ms, sys: 2.96 ms, total: 124 ms
    Wall time: 124 ms
