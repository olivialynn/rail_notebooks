...
.. parsed-literal::
    ...
    CPU times: user 8.6 s, sys: 1.97 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f83736b3f40>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8370fb34f0>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 938 ms, total: 12.7 s
    Wall time: 12.4 s
