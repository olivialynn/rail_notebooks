...
.. parsed-literal::
    ...
    CPU times: user 8.42 s, sys: 1.99 s, total: 10.4 s
    Wall time: 10.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff8581b6920>
...
.. parsed-literal::
    ...
    CPU times: user 48.2 s, sys: 10.5 s, total: 58.7 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff83cd330a0>
