...
.. parsed-literal::
    ...
    CPU times: user 9.01 s, sys: 1.82 s, total: 10.8 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa46c94f7c0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa4e0d0c520>
...
.. parsed-literal::
    ...
    CPU times: user 0 ns, sys: 209 µs, total: 209 µs
    Wall time: 214 µs
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 12 s, sys: 933 ms, total: 12.9 s
    Wall time: 12.6 s
