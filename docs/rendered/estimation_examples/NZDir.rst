...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faf721df190>
...
.. parsed-literal::
    ...
    CPU times: user 302 ms, sys: 8.39 ms, total: 310 ms
    Wall time: 309 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faf7066ea70>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 116 ms, sys: 19 μs, total: 116 ms
    Wall time: 116 ms
