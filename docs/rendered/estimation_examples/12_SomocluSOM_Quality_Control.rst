...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc2ed7ce5f0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc293d25c90>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc2917f56c0>
...
.. parsed-literal::
    ...
    CPU times: user 2min 12s, sys: 86.5 ms, total: 2min 12s
    Wall time: 33.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc2917b1540>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc29165a800>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7035/2502127049.py:8: UserWarning: set_ticklabels() should only be used with a fixed number of ticks, i.e. after set_ticks() or using a FixedLocator.
      ax.set_yticklabels(['SOM N(z), QC1+QC2', 'SOM N(z), QC2','SOM N(z), QC1', 'SOM N(z)'])
