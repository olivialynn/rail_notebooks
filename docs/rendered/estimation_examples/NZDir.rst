...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f33e1a47ca0>
...
.. parsed-literal::
    ...
    CPU times: user 312 ms, sys: 4.6 ms, total: 316 ms
    Wall time: 316 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f33e212fac0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 107 ms, sys: 7.63 ms, total: 114 ms
    Wall time: 114 ms
