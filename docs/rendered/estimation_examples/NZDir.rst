...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f376723bf70>
...
.. parsed-literal::
    ...
    CPU times: user 312 ms, sys: 353 μs, total: 312 ms
    Wall time: 311 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f374809b4f0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 116 ms, sys: 273 μs, total: 117 ms
    Wall time: 116 ms
