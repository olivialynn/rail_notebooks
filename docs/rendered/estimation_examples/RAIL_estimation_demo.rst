...
.. parsed-literal::
    ...
    CPU times: user 9.25 s, sys: 2.06 s, total: 11.3 s
    Wall time: 11.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff0b03b85b0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff09c3690c0>
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 12.3 s, sys: 871 ms, total: 13.1 s
    Wall time: 12.9 s
