...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 644 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2bc08c55d0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7407/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2ba9b626b0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2ba9af0700>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2baa0b6470>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2baa0880d0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7407/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2baa093e80>
