...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1b468503a0>
...
.. parsed-literal::
    ...
    CPU times: user 307 ms, sys: 214 µs, total: 308 ms
    Wall time: 307 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1b422383d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 107 ms, sys: 3.89 ms, total: 111 ms
    Wall time: 111 ms
