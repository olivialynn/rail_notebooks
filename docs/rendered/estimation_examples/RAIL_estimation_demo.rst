...
.. parsed-literal::
    ...
    CPU times: user 8.77 s, sys: 1.87 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcf315d1e70>
...
.. parsed-literal::
    ...
    CPU times: user 47 s, sys: 10.6 s, total: 57.6 s
    Wall time: 59.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcef6917c10>
