...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f68d9a238b0>
...
.. parsed-literal::
    ...
    CPU times: user 369 ms, sys: 3.01 ms, total: 372 ms
    Wall time: 371 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f68d570b250>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 5 ms, total: 122 ms
    Wall time: 122 ms
