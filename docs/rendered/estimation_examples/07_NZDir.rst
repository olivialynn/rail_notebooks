...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f563eaf2e60>
...
.. parsed-literal::
    ...
    CPU times: user 289 ms, sys: 3.14 ms, total: 292 ms
    Wall time: 292 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f563d5a1cc0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 4 ms, total: 126 ms
    Wall time: 126 ms
