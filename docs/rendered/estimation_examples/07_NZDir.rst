...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdfd14476a0>
...
.. parsed-literal::
    ...
    CPU times: user 321 ms, sys: 4.84 ms, total: 325 ms
    Wall time: 324 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdfcfa60df0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 133 ms, sys: 6.01 ms, total: 139 ms
    Wall time: 139 ms
