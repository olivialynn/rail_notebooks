...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f14a0087e80>
...
.. parsed-literal::
    ...
    CPU times: user 56.7 s, sys: 1.12 s, total: 57.8 s
    Wall time: 59.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f146a0df640>
...
.. parsed-literal::
    ...
    CPU times: user 12.2 s, sys: 137 ms, total: 12.4 s
    Wall time: 12.1 s
