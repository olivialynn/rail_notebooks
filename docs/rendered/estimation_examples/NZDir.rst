...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faabf66af20>
...
.. parsed-literal::
    ...
    CPU times: user 393 ms, sys: 619 μs, total: 394 ms
    Wall time: 394 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faabbb1cfa0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 125 ms, sys: 271 μs, total: 125 ms
    Wall time: 125 ms
