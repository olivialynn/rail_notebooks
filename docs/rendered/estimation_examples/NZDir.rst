...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd602397520>
...
.. parsed-literal::
    ...
    CPU times: user 400 ms, sys: 2.3 ms, total: 402 ms
    Wall time: 402 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd600a1e0b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 7.19 ms, total: 129 ms
    Wall time: 128 ms
