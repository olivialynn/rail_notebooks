...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff1512ce050>
...
.. parsed-literal::
    ...
    CPU times: user 305 ms, sys: 8.3 ms, total: 313 ms
    Wall time: 312 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff14cde2bc0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 118 ms, sys: 412 µs, total: 118 ms
    Wall time: 118 ms
