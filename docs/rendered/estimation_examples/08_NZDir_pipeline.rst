...
.. parsed-literal::
    ...
    (({'NZDirInformer': <Job NZDirInformer>,
      ...
      [<rail.estimation.algos.nz_dir.NZDirInformer at 0x7f62e7ce7790>,
       <rail.estimation.algos.nz_dir.NZDirSummarizer at 0x7f62e68eadd0>]),
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1   python3 -m ceci rail.estimation.algos.nz_dir.NZDirInformer   --input=/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/rail/examples_data/testdata/test_dc2_training_9816.hdf5   --config=nzdir_config.yml   --model=./nzdir_model.pkl 
...
.. parsed-literal::
    ...
    Job NZDirInformer has completed successfully in 3.0 seconds
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1  mpirun -n 2 python3 -m ceci rail.estimation.algos.nz_dir.NZDirSummarizer   --model=./nzdir_model.pkl   --input=/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/rail/examples_data/testdata/test_dc2_validation_9816.hdf5   --config=nzdir_config.yml   --output=./NZDir_samples.hdf5   --single_NZ=./NZDir_NZ.hdf5 --mpi
...
.. parsed-literal::
    ...
    Job NZDirSummarizer has failed with status 1
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f62a657b710>




.. image:: 08_NZDir_pipeline_files/08_NZDir_pipeline_15_1.png
