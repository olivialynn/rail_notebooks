...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdcd1cbe9b0>
...
.. parsed-literal::
    ...
    CPU times: user 357 ms, sys: 7.32 ms, total: 365 ms
    Wall time: 365 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdccdd12b00>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 133 ms, sys: 4.14 ms, total: 137 ms
    Wall time: 137 ms
