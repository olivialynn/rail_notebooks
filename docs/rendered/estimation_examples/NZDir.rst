...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5d3090ded0>
...
.. parsed-literal::
    ...
    CPU times: user 383 ms, sys: 7.8 ms, total: 391 ms
    Wall time: 391 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5ced7847f0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 124 ms, sys: 101 μs, total: 125 ms
    Wall time: 124 ms
