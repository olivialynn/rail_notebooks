...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f885927ef80>
...
.. parsed-literal::
    ...
    CPU times: user 294 ms, sys: 11.5 ms, total: 305 ms
    Wall time: 304 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88543abdc0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 107 ms, sys: 3.55 ms, total: 111 ms
    Wall time: 110 ms
