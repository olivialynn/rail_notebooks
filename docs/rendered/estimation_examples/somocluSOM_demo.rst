...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 948 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f952426db70>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7275/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f94cb9caef0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f94cb9ec6a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f94c976e290>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f94c976fa60>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7275/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f94c94179d0>
