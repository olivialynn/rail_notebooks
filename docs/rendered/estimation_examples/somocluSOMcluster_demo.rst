...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 337 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fed6495b6a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fed08334e20>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fed004c3340>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fed003f9450>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fed003fae30>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_6869/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fed008bff40>
