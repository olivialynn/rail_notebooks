...
.. parsed-literal::
    ...
    CPU times: user 8.89 s, sys: 1.82 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5d8c2ed780>
...
.. parsed-literal::
    ...
    CPU times: user 49.1 s, sys: 10.5 s, total: 59.5 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5d6ec49d20>
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 11.8 s, sys: 898 ms, total: 12.7 s
    Wall time: 12.4 s
