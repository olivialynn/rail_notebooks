...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 651 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8a146ab340>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7348/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f89b66e27d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f89b622dab0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f89b662e2f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f89b662f400>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7348/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f89b6a0c5b0>
