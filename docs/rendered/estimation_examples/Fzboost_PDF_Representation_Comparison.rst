...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.16/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:58:00] WARNING: /workspace/src/learner.cc:740: 
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f51235e28f0>
...
.. parsed-literal::
    ...
    CPU times: user 589 ms, sys: 74.2 ms, total: 663 ms
    Wall time: 1.36 s
...
.. parsed-literal::
    ...
    CPU times: user 9.12 s, sys: 279 ms, total: 9.4 s
    Wall time: 9.05 s
...
.. parsed-literal::
    ...
    CPU times: user 11.3 s, sys: 305 ms, total: 11.7 s
    Wall time: 11.3 s
...
.. parsed-literal::
    ...
    8.24 s ± 29.5 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 980 ms, total: 13 s
    Wall time: 12.7 s
...
.. parsed-literal::
    ...
    857 ms ± 5.03 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 364 ms, sys: 67.2 ms, total: 432 ms
    Wall time: 431 ms
...
.. parsed-literal::
    ...
    39.9 ms ± 578 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
