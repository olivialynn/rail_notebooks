...
.. parsed-literal::
    ...
    CPU times: user 8.43 s, sys: 1.9 s, total: 10.3 s
    Wall time: 10.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9691686380>
...
.. parsed-literal::
    ...
    CPU times: user 55.7 s, sys: 1.04 s, total: 56.7 s
    Wall time: 1min 5s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9708ed2350>
