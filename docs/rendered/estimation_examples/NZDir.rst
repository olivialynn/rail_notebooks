...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa0cde4ef80>
...
.. parsed-literal::
    ...
    CPU times: user 304 ms, sys: 3.71 ms, total: 308 ms
    Wall time: 307 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa0ca67d060>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 520 µs, total: 110 ms
    Wall time: 110 ms
