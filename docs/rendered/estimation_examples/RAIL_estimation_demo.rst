...
.. parsed-literal::
    ...
    CPU times: user 8.5 s, sys: 1.95 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f40d4cfbd60>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f40fc18bd00>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 1.07 s, total: 12.8 s
    Wall time: 12.5 s
