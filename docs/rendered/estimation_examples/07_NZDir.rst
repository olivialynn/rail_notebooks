...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f25fed73640>
...
.. parsed-literal::
    ...
    CPU times: user 352 ms, sys: 9.94 ms, total: 362 ms
    Wall time: 360 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f25fcf049a0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 120 ms, sys: 4.93 ms, total: 125 ms
    Wall time: 125 ms
