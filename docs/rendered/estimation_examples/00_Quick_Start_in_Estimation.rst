...
.. parsed-literal::
    ...
    CPU times: user 8.57 s, sys: 2.02 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe8eb1a3a90>
...
.. parsed-literal::
    ...
    CPU times: user 57.4 s, sys: 909 ms, total: 58.3 s
    Wall time: 1min 9s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe8ea93bc70>
