...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1466173a00>
...
.. parsed-literal::
    ...
    CPU times: user 47.6 s, sys: 10.5 s, total: 58.1 s
    Wall time: 59.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1464732020>
...
.. parsed-literal::
    ...
    CPU times: user 167 μs, sys: 34 μs, total: 201 μs
    Wall time: 205 μs
