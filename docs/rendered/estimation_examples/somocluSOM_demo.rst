...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 988 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1e1cd99c90>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7357/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f1dc14977f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f1dc13cd390>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f1dc133e4d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f1dc137d870>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7357/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f1dc6e17cd0>
