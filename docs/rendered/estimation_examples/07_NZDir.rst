...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9cf51136a0>
...
.. parsed-literal::
    ...
    CPU times: user 287 ms, sys: 5.07 ms, total: 292 ms
    Wall time: 291 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9cf36acc40>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 124 ms, sys: 3.02 ms, total: 127 ms
    Wall time: 126 ms
