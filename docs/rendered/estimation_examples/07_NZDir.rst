...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcdfc4e5fc0>
...
.. parsed-literal::
    ...
    CPU times: user 360 ms, sys: 5.96 ms, total: 366 ms
    Wall time: 366 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcdfaa9e9e0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 2.09 ms, total: 125 ms
    Wall time: 124 ms
