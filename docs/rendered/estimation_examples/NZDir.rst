...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8acb8db6d0>
...
.. parsed-literal::
    ...
    CPU times: user 366 ms, sys: 3.97 ms, total: 370 ms
    Wall time: 370 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8ac776bd60>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 113 ms, sys: 5.95 ms, total: 119 ms
    Wall time: 119 ms
