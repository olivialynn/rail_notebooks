...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8fbae6bf70>
...
.. parsed-literal::
    ...
    CPU times: user 291 ms, sys: 5.81 ms, total: 297 ms
    Wall time: 296 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8fb9573220>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 2.02 ms, total: 128 ms
    Wall time: 128 ms
