...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1cd2a67bb0>
...
.. parsed-literal::
    ...
    CPU times: user 315 ms, sys: 8.6 ms, total: 323 ms
    Wall time: 324 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1ccefcdd50>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 859 μs, total: 124 ms
    Wall time: 124 ms
