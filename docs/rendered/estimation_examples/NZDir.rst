...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ffb58312c20>
...
.. parsed-literal::
    ...
    CPU times: user 301 ms, sys: 13.2 ms, total: 314 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ffb544fcd90>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 111 ms, sys: 7.82 ms, total: 119 ms
    Wall time: 118 ms
