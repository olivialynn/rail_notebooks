...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 532 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ffb0c70b100>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ffaa7537400>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ffa9ffef760>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ffa9ff95240>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ffa9ff96320>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7424/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ffa9fe0fc10>
