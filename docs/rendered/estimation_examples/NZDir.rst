...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f83ef2b76d0>
...
.. parsed-literal::
    ...
    CPU times: user 378 ms, sys: 7.94 ms, total: 386 ms
    Wall time: 385 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f83ed781030>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 119 ms, sys: 7.71 ms, total: 126 ms
    Wall time: 126 ms
