...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4acdf2a290>
...
.. parsed-literal::
    ...
    CPU times: user 318 ms, sys: 8.02 ms, total: 326 ms
    Wall time: 326 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4accbfaa40>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 424 μs, total: 122 ms
    Wall time: 122 ms
