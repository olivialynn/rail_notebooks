...
.. parsed-literal::
    ...
    CPU times: user 8.78 s, sys: 2.02 s, total: 10.8 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe8d438e1d0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe8795f4b80>
...
.. parsed-literal::
    ...
    CPU times: user 11.9 s, sys: 997 ms, total: 12.9 s
    Wall time: 12.5 s
