...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x73f1a62c27d0>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x73f2040a1ba0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x73f1a63820b0>]),
