...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe4808cd8a0>
...
.. parsed-literal::
    ...
    CPU times: user 355 ms, sys: 4.04 ms, total: 359 ms
    Wall time: 358 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe42636f5e0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 119 ms, sys: 5.05 ms, total: 124 ms
    Wall time: 123 ms
