...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa8323bbfa0>
...
.. parsed-literal::
    ...
    CPU times: user 329 ms, sys: 8.06 ms, total: 337 ms
    Wall time: 336 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa830c3cc10>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 129 μs, total: 117 ms
    Wall time: 117 ms
