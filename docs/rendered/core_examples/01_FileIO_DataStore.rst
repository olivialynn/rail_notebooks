...
.. parsed-literal::
    ...
    {  train_data:<class 'rail.core.data.PqHandle'> None, (d)
      test_data:<class 'rail.core.data.TableHandle'> /opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/rail/examples_data/testdata/test_dc2_validation_9816.hdf5, (wd)
    }
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5cebec1510>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f5cec0ebbd0>




.. image:: 01_FileIO_DataStore_files/01_FileIO_DataStore_34_1.png
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f5ce8e63ed0>




.. image:: 01_FileIO_DataStore_files/01_FileIO_DataStore_37_1.png
