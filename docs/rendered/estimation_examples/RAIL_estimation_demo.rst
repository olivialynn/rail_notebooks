...
.. parsed-literal::
    ...
    CPU times: user 8.52 s, sys: 1.82 s, total: 10.3 s
    Wall time: 10.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb91574b0a0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb9151da8c0>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 937 ms, total: 12.8 s
    Wall time: 12.4 s
