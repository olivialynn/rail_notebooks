...
.. parsed-literal::
    ...
    CPU times: user 8min 23s, sys: 773 ms, total: 8min 24s
    Wall time: 2min 8s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbb90e9a050>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7385/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fbb43d23760>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fbb43d41450>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fbb3e3f64d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fbb484bcf40>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7385/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fbb3e3e7cd0>
