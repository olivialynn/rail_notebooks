...
.. parsed-literal::
    ...
    CPU times: user 8.68 s, sys: 1.86 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1709d47670>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f171cd0f3a0>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 988 ms, total: 12.8 s
    Wall time: 12.5 s
