...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe58f9a2830>
...
.. parsed-literal::
    ...
    CPU times: user 303 ms, sys: 3.48 ms, total: 307 ms
    Wall time: 306 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe58bbfb580>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 104 ms, sys: 3.94 ms, total: 108 ms
    Wall time: 107 ms
