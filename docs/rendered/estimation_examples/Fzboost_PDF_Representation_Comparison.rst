...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:36] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:37] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:38] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 49 s, sys: 10.4 s, total: 59.4 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4f183800d0>
...
.. parsed-literal::
    ...
    CPU times: user 8.96 s, sys: 265 ms, total: 9.22 s
    Wall time: 8.91 s
...
.. parsed-literal::
    ...
    8.26 s ± 22.8 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    867 ms ± 4.38 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 368 ms, sys: 59.2 ms, total: 427 ms
    Wall time: 427 ms
...
.. parsed-literal::
    ...
    40 ms ± 565 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
