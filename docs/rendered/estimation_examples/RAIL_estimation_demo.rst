...
.. parsed-literal::
    ...
    CPU times: user 12.1 s, sys: 3.37 s, total: 15.4 s
    Wall time: 15.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd27c137f40>
...
.. parsed-literal::
    ...
    CPU times: user 56.1 s, sys: 2.01 s, total: 58.1 s
    Wall time: 1min 59s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd2647aab00>
