...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 972 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f47146a8d60>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7287/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f46b7a0c1f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f46b7a4ca90>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f46b7ad2950>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f46b7ad3ee0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7287/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f46b78acbb0>
