...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:00:00] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 47.5 s, sys: 10.7 s, total: 58.2 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8cd40cfdc0>
...
.. parsed-literal::
    ...
    CPU times: user 552 ms, sys: 78.9 ms, total: 631 ms
    Wall time: 1.32 s
...
.. parsed-literal::
    ...
    CPU times: user 8.82 s, sys: 297 ms, total: 9.12 s
    Wall time: 8.77 s
...
.. parsed-literal::
    ...
    CPU times: user 10.9 s, sys: 336 ms, total: 11.2 s
    Wall time: 10.9 s
...
.. parsed-literal::
    ...
    8.24 s ± 22.6 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.4 s, sys: 1.04 s, total: 12.5 s
    Wall time: 12.2 s
...
.. parsed-literal::
    ...
    817 ms ± 2.59 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 369 ms, sys: 71 ms, total: 440 ms
    Wall time: 439 ms
...
.. parsed-literal::
    ...
    40.9 ms ± 866 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
