...
.. parsed-literal::
    ...
    CPU times: user 9.09 s, sys: 1.97 s, total: 11.1 s
    Wall time: 11.1 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f443221fd90>
...
.. parsed-literal::
    ...
    CPU times: user 49.8 s, sys: 10.4 s, total: 1min
    Wall time: 1min 2s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4431d535e0>
