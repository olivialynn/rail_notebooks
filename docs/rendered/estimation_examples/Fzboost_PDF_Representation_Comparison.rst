...
.. parsed-literal::
    ...
    CPU times: user 47.9 s, sys: 10.8 s, total: 58.7 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f98abf439a0>
...
.. parsed-literal::
    ...
    CPU times: user 8.8 s, sys: 306 ms, total: 9.1 s
    Wall time: 8.75 s
...
.. parsed-literal::
    ...
    8.16 s ± 24.7 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    874 ms ± 4.81 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 341 ms, sys: 92.3 ms, total: 434 ms
    Wall time: 433 ms
...
.. parsed-literal::
    ...
    40.1 ms ± 324 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
