...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd16c9daa70>
...
.. parsed-literal::
    ...
    CPU times: user 360 ms, sys: 3.06 ms, total: 363 ms
    Wall time: 362 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd1124829e0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 118 ms, sys: 5.03 ms, total: 123 ms
    Wall time: 123 ms
