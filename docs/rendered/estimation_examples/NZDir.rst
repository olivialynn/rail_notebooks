...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8ca475d390>
...
.. parsed-literal::
    ...
    CPU times: user 343 ms, sys: 7.97 ms, total: 351 ms
    Wall time: 351 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8ca2a34fa0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 128 ms, sys: 21 µs, total: 128 ms
    Wall time: 128 ms
