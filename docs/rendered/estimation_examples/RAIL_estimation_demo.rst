...
.. parsed-literal::
    ...
    CPU times: user 9.48 s, sys: 2.15 s, total: 11.6 s
    Wall time: 11.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa1dd4db760>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa1dcca0070>
...
.. parsed-literal::
    ...
    CPU times: user 11.9 s, sys: 999 ms, total: 12.9 s
    Wall time: 12.6 s
