...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2acd3dafe0>
...
.. parsed-literal::
    ...
    CPU times: user 298 ms, sys: 8.35 ms, total: 307 ms
    Wall time: 306 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2acbae62c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 103 ms, sys: 9.16 ms, total: 112 ms
    Wall time: 111 ms
