...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f80a55735b0>
...
.. parsed-literal::
    ...
    CPU times: user 358 ms, sys: 3.5 ms, total: 361 ms
    Wall time: 361 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f80a3d5ece0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 134 ms, sys: 7.8 ms, total: 142 ms
    Wall time: 143 ms
