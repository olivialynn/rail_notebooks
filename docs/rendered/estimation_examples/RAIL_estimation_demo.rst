...
.. parsed-literal::
    ...
    CPU times: user 8.93 s, sys: 2.05 s, total: 11 s
    Wall time: 11 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdd4065ffd0>
...
.. parsed-literal::
    ...
    CPU times: user 48.5 s, sys: 10.4 s, total: 58.9 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdcfc940580>
