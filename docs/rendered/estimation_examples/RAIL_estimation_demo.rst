...
.. parsed-literal::
    ...
    CPU times: user 8.65 s, sys: 2 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f893ca860b0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88f05641c0>
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 1.01 s, total: 12.8 s
    Wall time: 12.4 s
