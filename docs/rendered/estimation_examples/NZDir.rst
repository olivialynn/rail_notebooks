...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdb4645a830>
...
.. parsed-literal::
    ...
    CPU times: user 311 ms, sys: 290 µs, total: 311 ms
    Wall time: 311 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdb4223f070>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 108 ms, sys: 8.04 ms, total: 116 ms
    Wall time: 116 ms
