...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9b8ba475b0>
...
.. parsed-literal::
    ...
    CPU times: user 346 ms, sys: 375 µs, total: 346 ms
    Wall time: 347 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f9b87a29f90>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 3.89 ms, total: 127 ms
    Wall time: 126 ms
