...
.. parsed-literal::
    ...
    CPU times: user 8min 19s, sys: 887 ms, total: 8min 20s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4e442f53c0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7285/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f4de2b6f670>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4de2b94430>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f4de2b7aa40>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4de2b7abc0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7285/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4deab08bb0>
