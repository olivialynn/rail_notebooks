...
.. parsed-literal::
    ...
    CPU times: user 8.41 s, sys: 1.75 s, total: 10.2 s
    Wall time: 10.2 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f348a2b7eb0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f348a1cdcc0>
...
.. parsed-literal::
    ...
    CPU times: user 11.9 s, sys: 971 ms, total: 12.8 s
    Wall time: 12.5 s
