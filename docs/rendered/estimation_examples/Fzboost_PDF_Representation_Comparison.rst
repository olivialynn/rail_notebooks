...
.. parsed-literal::
    ...
    CPU times: user 50.4 s, sys: 10.5 s, total: 1min
    Wall time: 1min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f86db0c2200>
...
.. parsed-literal::
    ...
    CPU times: user 9.2 s, sys: 331 ms, total: 9.54 s
    Wall time: 9.19 s
...
.. parsed-literal::
    ...
    CPU times: user 11.5 s, sys: 303 ms, total: 11.9 s
    Wall time: 11.5 s
...
.. parsed-literal::
    ...
    8.57 s ± 28 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 958 ms, total: 12.9 s
    Wall time: 12.6 s
...
.. parsed-literal::
    ...
    872 ms ± 5.17 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 406 ms, sys: 111 ms, total: 517 ms
    Wall time: 517 ms
...
.. parsed-literal::
    ...
    43.3 ms ± 1.66 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
