...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 685 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f49ab13f7f0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7372/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f4997ae3820>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4997b20160>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f49958924d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f49958a5870>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7372/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f499563bbb0>
