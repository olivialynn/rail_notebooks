...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7fb5fc308070>
...
.. parsed-literal::
    ...
    best fit z0, alpha, km for type 0: [0.2552435  1.35888238 0.06148737]
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:30:15] WARNING: /workspace/src/learner.cc:742: 
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:30:19] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:30:20] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb5ecf254e0>
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7fb5ecf42a40>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fb5ecfe75e0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fb5ecfe5000>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7fb5ecf40dc0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fb5ed552950>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fb689f04610>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7fb5eef888b0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fb5ecfe5990>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fb5ecfe5420>}}
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7fb64bfa75e0>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fb5fc1a46d0>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7fb5fc30a560>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7fb5fc1dc490>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fb5fc30b970>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7fb5fc30beb0>,
       <rail.creation.degradation.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7fb5fc30a470>,
       <rail.creation.degradation.spectroscopic_degraders.LineConfusion at 0x7fb5fc30a830>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7fb5fc309ed0>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7fb5eef8aaa0>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7fb5eef7bee0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7fb5fc30b1f0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7fb5ecf26c20>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7fb5fc30b490>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7fb5ecf40c70>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7fb5ecfe64d0>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7fb5ecfe6a10>]),
