...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa8f3abb970>
...
.. parsed-literal::
    ...
    CPU times: user 373 ms, sys: 6.73 ms, total: 380 ms
    Wall time: 379 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa94c3d7a30>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 3.96 ms, total: 126 ms
    Wall time: 126 ms
