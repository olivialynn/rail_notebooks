...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3d1a31be80>
...
.. parsed-literal::
    ...
    CPU times: user 351 ms, sys: 5.98 ms, total: 357 ms
    Wall time: 356 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3d1892c670>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 983 μs, total: 124 ms
    Wall time: 123 ms
