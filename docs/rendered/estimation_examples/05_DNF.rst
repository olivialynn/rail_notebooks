...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb6dbfc69e0>
...
.. parsed-literal::
    ...
    CPU times: user 16.3 s, sys: 363 ms, total: 16.6 s
    Wall time: 16.6 s
...
.. parsed-literal::
    ...
    CPU times: user 13.3 s, sys: 345 ms, total: 13.7 s
    Wall time: 13.6 s
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fb6809a4d90>
