...
.. parsed-literal::
    ...
    CPU times: user 8.61 s, sys: 1.89 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff038603070>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff022e8e140>
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 920 ms, total: 12.6 s
    Wall time: 12.3 s
