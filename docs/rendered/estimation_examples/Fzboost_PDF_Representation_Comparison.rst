...
.. parsed-literal::
    ...
    CPU times: user 48.6 s, sys: 10.6 s, total: 59.2 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff77c1ab190>
...
.. parsed-literal::
    ...
    CPU times: user 530 ms, sys: 75 ms, total: 605 ms
    Wall time: 1.33 s
...
.. parsed-literal::
    ...
    CPU times: user 8.9 s, sys: 287 ms, total: 9.19 s
    Wall time: 8.84 s
...
.. parsed-literal::
    ...
    8.21 s ± 26.8 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.6 s, sys: 945 ms, total: 12.5 s
    Wall time: 12.2 s
...
.. parsed-literal::
    ...
    878 ms ± 9.56 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    40.8 ms ± 494 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
