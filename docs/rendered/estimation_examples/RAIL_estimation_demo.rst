...
.. parsed-literal::
    ...
    CPU times: user 8.23 s, sys: 2.02 s, total: 10.3 s
    Wall time: 10.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd53010bfa0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd52bb42350>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 974 ms, total: 12.7 s
    Wall time: 12.4 s
