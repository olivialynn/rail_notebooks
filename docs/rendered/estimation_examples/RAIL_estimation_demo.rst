...
.. parsed-literal::
    ...
    CPU times: user 9.15 s, sys: 2.01 s, total: 11.2 s
    Wall time: 11.2 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc86a257010>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc869c3caf0>
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 979 ms, total: 12.9 s
    Wall time: 12.7 s
