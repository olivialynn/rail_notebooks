...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb7395265c0>
...
.. parsed-literal::
    ...
    CPU times: user 318 ms, sys: 12 ms, total: 330 ms
    Wall time: 329 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb73531bc70>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 115 ms, sys: 8.77 ms, total: 124 ms
    Wall time: 123 ms
