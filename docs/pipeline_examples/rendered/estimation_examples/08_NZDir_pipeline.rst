...
For interactive pipeline creation to work, your data must be input as
DataHandles, so that it will pass along the appropriate tags to the
stages.
...
.. parsed-literal::
    ...
    Inserting handle into data store.  training_data: None, NZDirInformer
...
.. parsed-literal::
    ...
    Inserting handle into data store.  test_data: None, NZDirSummarizer
...
.. parsed-literal::
    ...
    (({'NZDirInformer': <Job NZDirInformer>,
      ...
      [<rail.estimation.algos.nz_dir.NZDirInformer at 0x7f4f28183b80>,
       <rail.estimation.algos.nz_dir.NZDirSummarizer at 0x7f4f28181750>]),
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4ec6fb0f40>
