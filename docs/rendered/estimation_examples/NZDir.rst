...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7e8e9cafe0>
...
.. parsed-literal::
    ...
    CPU times: user 311 ms, sys: 8.2 ms, total: 319 ms
    Wall time: 320 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7e8abb0a30>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 580 μs, total: 118 ms
    Wall time: 118 ms
