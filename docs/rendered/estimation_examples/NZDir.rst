...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff8664b3a30>
...
.. parsed-literal::
    ...
    CPU times: user 358 ms, sys: 3.41 ms, total: 361 ms
    Wall time: 360 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff8ae16b460>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 7.73 ms, total: 134 ms
    Wall time: 135 ms
