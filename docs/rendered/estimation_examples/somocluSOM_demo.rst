...
.. parsed-literal::
    ...
    CPU times: user 8min 18s, sys: 392 ms, total: 8min 18s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7df8102050>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7334/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f7d9b301990>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f7d9b035120>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f7d9af20e50>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f7d94903a90>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7334/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f7d9af9f430>
