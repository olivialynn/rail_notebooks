...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4eff08f0d0>
...
.. parsed-literal::
    ...
    CPU times: user 299 ms, sys: 2.07 ms, total: 301 ms
    Wall time: 300 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4efdafa170>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 124 ms, sys: 5.96 ms, total: 130 ms
    Wall time: 130 ms
