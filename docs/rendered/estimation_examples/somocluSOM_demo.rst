...
.. parsed-literal::
    ...
    CPU times: user 8min 19s, sys: 805 ms, total: 8min 20s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f09c8328f70>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7381/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f0967a9d660>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f0967ac0820>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f0967969e40>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f096796a8c0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7381/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f09678481c0>
