...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f209686f2e0>
...
.. parsed-literal::
    ...
    CPU times: user 459 ms, sys: 7.9 ms, total: 467 ms
    Wall time: 470 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2094f0cbe0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 152 ms, sys: 11.6 ms, total: 164 ms
    Wall time: 165 ms
