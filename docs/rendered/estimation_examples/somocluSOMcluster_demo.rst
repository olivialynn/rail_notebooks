...
.. parsed-literal::
    ...
    CPU times: user 8min 3s, sys: 750 ms, total: 8min 4s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff3c8b4f130>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff372917370>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff37002b940>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff36931d480>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff36931dcc0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_16020/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff361dcfd90>
