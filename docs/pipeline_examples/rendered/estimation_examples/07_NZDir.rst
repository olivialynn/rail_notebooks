...
`NZDir.ipynb <https://github.com/LSSTDESC/rail/blob/main/interactive_examples/estimation_examples/NZDir.ipynb>`__
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4babd62b90>
...
.. parsed-literal::
    ...
    CPU times: user 287 ms, sys: 7.95 ms, total: 295 ms
    Wall time: 295 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4babd627d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 128 ms, sys: 2.99 ms, total: 131 ms
    Wall time: 131 ms
