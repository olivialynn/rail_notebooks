...
.. parsed-literal::
    ...
    CPU times: user 9.05 s, sys: 1.87 s, total: 10.9 s
    Wall time: 10.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe2ea6bff40>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe2ea2e8040>
...
.. parsed-literal::
    ...
    CPU times: user 12.3 s, sys: 957 ms, total: 13.2 s
    Wall time: 12.9 s
