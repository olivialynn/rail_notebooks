...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ffad00839a0>
...
.. parsed-literal::
    ...
    CPU times: user 305 ms, sys: 6.96 ms, total: 311 ms
    Wall time: 311 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ffacd63d5d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 114 ms, sys: 4.5 ms, total: 118 ms
    Wall time: 118 ms
