...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd77b5fcd60>
...
.. parsed-literal::
    ...
    CPU times: user 16.4 s, sys: 442 ms, total: 16.8 s
    Wall time: 16.8 s
...
.. parsed-literal::
    ...
    CPU times: user 13.1 s, sys: 387 ms, total: 13.4 s
    Wall time: 13.4 s
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fd764873a00>
