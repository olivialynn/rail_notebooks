...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6ada12b760>
...
.. parsed-literal::
    ...
    CPU times: user 377 ms, sys: 3.05 ms, total: 380 ms
    Wall time: 379 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6ada12b6a0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 7.02 ms, total: 130 ms
    Wall time: 130 ms
