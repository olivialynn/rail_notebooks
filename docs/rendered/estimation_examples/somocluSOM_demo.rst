...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 613 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc6f4a2e2c0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc69a38a980>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc69a47c8e0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fc69a3ba2f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc69a3bad70>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7342/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fc69a2c47f0>
