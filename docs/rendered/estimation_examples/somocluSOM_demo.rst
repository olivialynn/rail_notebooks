...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 851 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3a9da51510>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7456/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f3a3db0cd60>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3a3db0ce80>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f3a3da77520>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3a3da77850>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7456/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3a379c1330>
