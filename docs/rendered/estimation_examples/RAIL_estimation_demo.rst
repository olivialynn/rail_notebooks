...
.. parsed-literal::
    ...
    CPU times: user 8.98 s, sys: 1.86 s, total: 10.8 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbb6635a440>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbb6520d3f0>
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 977 ms, total: 13 s
    Wall time: 12.7 s
