...
.. parsed-literal::
    ...
    CPU times: user 8.73 s, sys: 1.83 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe17deecee0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe14c56c4c0>
...
.. parsed-literal::
    ...
    CPU times: user 12.4 s, sys: 953 ms, total: 13.3 s
    Wall time: 13 s
