...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f07666ef070>
...
.. parsed-literal::
    ...
    CPU times: user 300 ms, sys: 20.2 ms, total: 320 ms
    Wall time: 321 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f076282ecb0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 112 ms, sys: 8.03 ms, total: 120 ms
    Wall time: 120 ms
