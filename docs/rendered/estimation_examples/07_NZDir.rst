...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6daa47e7d0>
...
.. parsed-literal::
    ...
    CPU times: user 350 ms, sys: 9.07 ms, total: 359 ms
    Wall time: 357 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6da84f34c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 6.99 ms, total: 124 ms
    Wall time: 124 ms
