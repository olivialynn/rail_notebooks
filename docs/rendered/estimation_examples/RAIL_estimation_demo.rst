...
.. parsed-literal::
    ...
    CPU times: user 8.78 s, sys: 1.97 s, total: 10.8 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8f68e4aa10>
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:56] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:57] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8f355a47f0>
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 949 ms, total: 12.9 s
    Wall time: 12.6 s
