...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7fbfd8343040>
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:03:20] WARNING: /workspace/src/learner.cc:738: 
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:03:21] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:03:24] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:03:25] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbf8477e770>
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7fbf847ee500>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fbf847ef490>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fbf74a5b550>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7fbf74a5a8c0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fbf74a59510>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fbf74a5b1f0>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7fbf748c1c00>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fbf748c1180>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fbf748c29b0>}}
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7fbfc61b1f60>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fbfa4cd0280>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fbf84d142b0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fbfa4cd0c70>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fbfa4cb29e0>,
       <rail.creation.degraders.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7fbfa4cd0130>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.creation.degraders.spectroscopic_degraders.LineConfusion at 0x7fbfa4cd3730>,
       <rail.tools.table_tools.TableConverter at 0x7fbfa4cb21d0>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.tools.table_tools.TableConverter at 0x7fbfa4cb01c0>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7fbf84ca6830>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7fbf84ca7790>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7fbf84ca78e0>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7fbf846d78e0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7fbf846d79d0>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7fbf846d46d0>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7fbf847ef730>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7fbf847ee170>]),
