...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 342 ms, total: 8min 6s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f952d56b7c0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f952a3d2bf0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f95241bf700>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f9517fc11e0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f95240fc610>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7391/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f9517f73160>
