...
.. parsed-literal::
    ...
    CPU times: user 8.7 s, sys: 2.02 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8f8c5579d0>
...
.. parsed-literal::
    ...
    CPU times: user 48.4 s, sys: 10.4 s, total: 58.9 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8f64f561d0>
