...
.. parsed-literal::
    ...
    CPU times: user 8.77 s, sys: 1.9 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2dc64d9a50>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2dc5f665f0>
...
.. parsed-literal::
    ...
    CPU times: user 12.1 s, sys: 957 ms, total: 13.1 s
    Wall time: 12.7 s
