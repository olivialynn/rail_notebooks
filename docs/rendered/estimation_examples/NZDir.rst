...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdd08632740>
...
.. parsed-literal::
    ...
    CPU times: user 448 ms, sys: 5.3 ms, total: 453 ms
    Wall time: 457 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdd0477f1c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 176 ms, sys: 37 µs, total: 176 ms
    Wall time: 176 ms
