...
.. parsed-literal::
    ...
    CPU times: user 8.63 s, sys: 1.89 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f666c0b7dc0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f666baafeb0>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 976 ms, total: 12.8 s
    Wall time: 12.5 s
