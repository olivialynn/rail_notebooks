...
.. parsed-literal::
    ...
    CPU times: user 8.41 s, sys: 1.73 s, total: 10.1 s
    Wall time: 10.1 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd890b57880>
...
.. parsed-literal::
    ...
    CPU times: user 47.2 s, sys: 10.4 s, total: 57.6 s
    Wall time: 59.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd85c32ed40>
