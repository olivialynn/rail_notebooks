...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:38] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:39] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [07:06:40] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 56.6 s, sys: 1.28 s, total: 57.8 s
    Wall time: 59.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4ad75767d0>
...
.. parsed-literal::
    ...
    CPU times: user 500 ms, sys: 97.8 ms, total: 598 ms
    Wall time: 1.3 s
...
.. parsed-literal::
    ...
    CPU times: user 8.73 s, sys: 34.9 ms, total: 8.76 s
    Wall time: 8.4 s
...
.. parsed-literal::
    ...
    CPU times: user 10.7 s, sys: 78.7 ms, total: 10.8 s
    Wall time: 10.4 s
...
.. parsed-literal::
    ...
    7.66 s ± 55.1 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 12 s, sys: 136 ms, total: 12.1 s
    Wall time: 11.8 s
...
.. parsed-literal::
    ...
    865 ms ± 11.1 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 205 ms, sys: 80.3 ms, total: 286 ms
    Wall time: 285 ms
...
.. parsed-literal::
    ...
    36.8 ms ± 628 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
