...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f57f15eb4f0>
...
.. parsed-literal::
    ...
    CPU times: user 306 ms, sys: 4.7 ms, total: 311 ms
    Wall time: 311 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f57f2245210>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 6.5 ms, total: 117 ms
    Wall time: 116 ms
