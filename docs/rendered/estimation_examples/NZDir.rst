...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdc7bc51a50>
...
.. parsed-literal::
    ...
    CPU times: user 393 ms, sys: 15.5 ms, total: 409 ms
    Wall time: 409 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdc7c379a80>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 127 ms, sys: 486 μs, total: 127 ms
    Wall time: 127 ms
