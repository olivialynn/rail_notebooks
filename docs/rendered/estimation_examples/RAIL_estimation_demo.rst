...
.. parsed-literal::
    ...
    CPU times: user 8.6 s, sys: 1.87 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fec487875b0>
...
.. parsed-literal::
    ...
    CPU times: user 57 s, sys: 1.13 s, total: 58.1 s
    Wall time: 59.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fec4856dcf0>
