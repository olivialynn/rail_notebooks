...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f98edeaf760>
...
.. parsed-literal::
    ...
    CPU times: user 285 ms, sys: 9.93 ms, total: 294 ms
    Wall time: 294 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f98ea30d660>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 2.98 ms, total: 129 ms
    Wall time: 129 ms
