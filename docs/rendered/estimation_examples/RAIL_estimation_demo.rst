...
.. parsed-literal::
    ...
    CPU times: user 9.01 s, sys: 1.88 s, total: 10.9 s
    Wall time: 10.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f309c2ce980>
...
.. parsed-literal::
    ...
    CPU times: user 49 s, sys: 10.5 s, total: 59.4 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3085baa2c0>
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 11.7 s, sys: 967 ms, total: 12.7 s
    Wall time: 12.4 s
