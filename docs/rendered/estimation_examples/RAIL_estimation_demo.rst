...
.. parsed-literal::
    ...
    CPU times: user 8.83 s, sys: 1.8 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe8449c7df0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe7ac945c00>
...
.. parsed-literal::
    ...
    CPU times: user 11.4 s, sys: 965 ms, total: 12.3 s
    Wall time: 12.1 s
