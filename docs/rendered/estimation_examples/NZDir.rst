...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd7f412a7d0>
...
.. parsed-literal::
    ...
    CPU times: user 317 ms, sys: 7.83 ms, total: 325 ms
    Wall time: 323 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd7f2753f10>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 111 ms, sys: 669 µs, total: 111 ms
    Wall time: 111 ms
