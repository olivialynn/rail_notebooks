...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f242ddab280>
...
.. parsed-literal::
    ...
    CPU times: user 304 ms, sys: 3.77 ms, total: 307 ms
    Wall time: 307 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f242c3a3cd0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 829 µs, total: 111 ms
    Wall time: 110 ms
