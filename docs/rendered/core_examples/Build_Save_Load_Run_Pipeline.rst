...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x7f8d5ba42260>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7f8dbca768f0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7f8d5b90d0c0>]),
