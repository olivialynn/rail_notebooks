...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8343eaaf80>
...
.. parsed-literal::
    ...
    CPU times: user 299 ms, sys: 2.96 ms, total: 302 ms
    Wall time: 301 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f83402a38b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 6.02 ms, total: 128 ms
    Wall time: 128 ms
