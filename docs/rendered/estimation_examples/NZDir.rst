...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f70949277c0>
...
.. parsed-literal::
    ...
    CPU times: user 388 ms, sys: 5.04 ms, total: 393 ms
    Wall time: 394 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7090dbfe20>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 118 ms, sys: 7.51 ms, total: 126 ms
    Wall time: 125 ms
