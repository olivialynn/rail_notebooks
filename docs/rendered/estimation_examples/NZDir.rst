...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff8d0015390>
...
.. parsed-literal::
    ...
    CPU times: user 314 ms, sys: 49 µs, total: 314 ms
    Wall time: 314 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff8deb17f70>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 114 ms, sys: 3.47 ms, total: 118 ms
    Wall time: 117 ms
