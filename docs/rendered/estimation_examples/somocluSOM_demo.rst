...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 708 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f80da2b92a0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7249/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f807a0a31f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f8079ee80a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f8079f6a980>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f807a0a30d0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7249/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f8079e48e20>
