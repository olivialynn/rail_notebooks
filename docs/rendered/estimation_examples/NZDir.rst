...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f260e1ca6b0>
...
.. parsed-literal::
    ...
    CPU times: user 305 ms, sys: 8.77 ms, total: 314 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f260c2cf400>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 112 ms, sys: 35 µs, total: 112 ms
    Wall time: 112 ms
