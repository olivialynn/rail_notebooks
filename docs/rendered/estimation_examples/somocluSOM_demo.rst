...
.. parsed-literal::
    ...
    CPU times: user 8min 7s, sys: 684 ms, total: 8min 7s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5b60c0dd50>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7392/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f5b14d93730>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f5b14e4c400>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f5b14a9a350>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f5b14a9b190>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7392/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f5b15363d00>
