...
.. parsed-literal::
    ...
    CPU times: user 8.69 s, sys: 1.83 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc081252620>
...
.. parsed-literal::
    ...
    CPU times: user 49.2 s, sys: 10.4 s, total: 59.6 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc028eddb70>
