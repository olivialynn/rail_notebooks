...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 625 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f568089f310>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7213/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f561f30d840>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f561f2d8610>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f561f415c90>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f561f4166e0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7213/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f561f34fdf0>
