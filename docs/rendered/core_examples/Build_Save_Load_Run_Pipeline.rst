...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x7f3d366e7c70>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7f3d944023b0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7f3d36792200>]),
