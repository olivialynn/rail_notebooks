...
.. parsed-literal::
    ...
    CPU times: user 8min 9s, sys: 685 ms, total: 8min 10s
    Wall time: 2min 5s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4048e86920>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7135/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f3fed1c7340>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3fed1706a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f3fed6c65f0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3fed703fd0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7135/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3fed6d4790>
