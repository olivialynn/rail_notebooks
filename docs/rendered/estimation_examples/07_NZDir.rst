...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88c36031f0>
...
.. parsed-literal::
    ...
    CPU times: user 303 ms, sys: 9.1 ms, total: 312 ms
    Wall time: 311 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88c1ec7a90>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 133 ms, sys: 4.96 ms, total: 138 ms
    Wall time: 138 ms
