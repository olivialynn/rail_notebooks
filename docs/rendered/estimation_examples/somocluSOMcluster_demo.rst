...
.. parsed-literal::
    ...
    CPU times: user 8min 9s, sys: 559 ms, total: 8min 10s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2b5bddf3a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2b58204d60>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b582af8b0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2b5ae78d00>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b5ae79540>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7417/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b504778b0>
