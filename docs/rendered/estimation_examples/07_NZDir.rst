...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8cf31a2b30>
...
.. parsed-literal::
    ...
    CPU times: user 348 ms, sys: 6.92 ms, total: 355 ms
    Wall time: 354 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8ceefe4cd0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 1.93 ms, total: 124 ms
    Wall time: 124 ms
