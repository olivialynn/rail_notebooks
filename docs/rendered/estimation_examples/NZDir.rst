...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa855adfaf0>
...
.. parsed-literal::
    ...
    CPU times: user 302 ms, sys: 8.82 ms, total: 311 ms
    Wall time: 310 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa851cd1270>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 109 ms, sys: 8.34 ms, total: 118 ms
    Wall time: 117 ms
