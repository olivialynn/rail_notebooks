...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3448599840>
...
.. parsed-literal::
    ...
    CPU times: user 317 ms, sys: 4.98 ms, total: 322 ms
    Wall time: 321 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f33f09a8850>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 118 ms, sys: 1.96 ms, total: 120 ms
    Wall time: 119 ms
