...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fac3391f1c0>
...
.. parsed-literal::
    ...
    CPU times: user 319 ms, sys: 4.11 ms, total: 323 ms
    Wall time: 322 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fac3391e0b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 121 ms, sys: 1.88 ms, total: 122 ms
    Wall time: 122 ms
