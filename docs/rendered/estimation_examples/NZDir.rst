...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe42551b610>
...
.. parsed-literal::
    ...
    CPU times: user 307 ms, sys: 7.93 ms, total: 315 ms
    Wall time: 314 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe4218abf40>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 105 ms, sys: 13.9 ms, total: 119 ms
    Wall time: 118 ms
