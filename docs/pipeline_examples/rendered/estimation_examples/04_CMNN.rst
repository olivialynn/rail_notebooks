...
from the ``00_Quick_Start_in_Estimation.ipynb`` in the RAIL repo, so
look at that notebook for general questions on setting up the RAIL
...
.. parsed-literal::
    ...
    CPU times: user 1.39 ms, sys: 1.04 ms, total: 2.43 ms
    Wall time: 2.23 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbacc5d1c30>
...
.. parsed-literal::
    ...
    CPU times: user 47.8 s, sys: 7.02 ms, total: 47.8 s
    Wall time: 47.8 s
