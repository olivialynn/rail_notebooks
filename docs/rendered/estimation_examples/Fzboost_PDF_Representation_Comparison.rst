...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:58:17] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:58:18] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:58:19] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:59:10] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:59:11] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/xgboost/core.py:158: UserWarning: [06:59:12] WARNING: /workspace/src/learner.cc:740: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 47 s, sys: 10.8 s, total: 57.8 s
    Wall time: 59.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f560f9d9ba0>
...
.. parsed-literal::
    ...
    CPU times: user 507 ms, sys: 76.3 ms, total: 584 ms
    Wall time: 1.29 s
...
.. parsed-literal::
    ...
    CPU times: user 8.81 s, sys: 273 ms, total: 9.09 s
    Wall time: 8.73 s
...
.. parsed-literal::
    ...
    CPU times: user 10.7 s, sys: 341 ms, total: 11 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    8.05 s ± 46.2 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.2 s, sys: 987 ms, total: 12.2 s
    Wall time: 11.9 s
...
.. parsed-literal::
    ...
    842 ms ± 9.2 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    42.3 ms ± 948 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
