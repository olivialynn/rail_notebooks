...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa845713bb0>
...
.. parsed-literal::
    ...
    CPU times: user 307 ms, sys: 3.83 ms, total: 311 ms
    Wall time: 310 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa843d2b100>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 112 ms, sys: 64 µs, total: 112 ms
    Wall time: 111 ms
