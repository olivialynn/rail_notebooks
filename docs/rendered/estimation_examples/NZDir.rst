...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd899027bb0>
...
.. parsed-literal::
    ...
    CPU times: user 354 ms, sys: 5.04 ms, total: 359 ms
    Wall time: 358 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd8973b5ea0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 965 μs, total: 124 ms
    Wall time: 124 ms
