...
.. parsed-literal::
    ...
    CPU times: user 8min 4s, sys: 974 ms, total: 8min 5s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f33ececd7e0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7458/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f33975e1420>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f33975ed0f0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f33973067d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3397306ad0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7458/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f339725cac0>
