...
.. parsed-literal::
    ...
    CPU times: user 8.73 s, sys: 1.79 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f056414af80>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f0550affb20>
...
.. parsed-literal::
    ...
    CPU times: user 11.6 s, sys: 989 ms, total: 12.6 s
    Wall time: 12.3 s
