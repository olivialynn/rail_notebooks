...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 970 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f342decf7c0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7369/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f341842abc0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3418464700>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f34184ea500>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f34184fc0d0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7369/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f3418193be0>
