...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efd843247f0>
...
.. parsed-literal::
    ...
    CPU times: user 48.7 s, sys: 10.3 s, total: 59 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efd3823a140>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 1.05 s, total: 12.9 s
    Wall time: 12.6 s
