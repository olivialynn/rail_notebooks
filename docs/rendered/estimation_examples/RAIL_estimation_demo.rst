...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f10d073e290>
...
.. parsed-literal::
    ...
    CPU times: user 48.5 s, sys: 10.5 s, total: 58.9 s
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f10d0097e20>
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 935 ms, total: 12.6 s
    Wall time: 12.3 s
