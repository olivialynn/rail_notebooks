...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7f10eff3b910>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f10edd682e0>
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7f1158b1a980>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7f10f80ef3a0>,
       ...
       <rail.core.utilStages.TableConverter at 0x7f10f811aaa0>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7f10efb86a70>,
       LSSTErrorModel parameters:
       ...
       Extinction coefficient for each band:
          mag_u_lsst: 0.491, mag_g_lsst: 0.213, mag_r_lsst: 0.126, mag_i_lsst: 0.096, mag_z_lsst: 0.069, mag_y_lsst: 0.17,
       <rail.creation.degradation.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7f10efb86650>,
       <rail.creation.degradation.spectroscopic_degraders.LineConfusion at 0x7f10efb85a80>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.utilStages.TableConverter at 0x7f10efb874f0>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7f10f811a710>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7f1100ea38e0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7f1100ea26b0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7f10dca5f130>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7f1100f5e9b0>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7f10dca5d810>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7f10dca8b5e0>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7f10dca8b3d0>]),
...
.. parsed-literal::
    ...
    [07:25:53] WARNING: ../src/learner.cc:767: 
    ...
    [07:25:54] WARNING: ../src/learner.cc:767: 
    Parameters: { "silent" } are not used.
    ...
    [07:26:02] WARNING: ../src/learner.cc:767: 
    Parameters: { "silent" } are not used.
    ...
    [07:26:03] WARNING: ../src/learner.cc:767: 
    Parameters: { "silent" } are not used.
