...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1464ba0e20>
...
.. parsed-literal::
    ...
    CPU times: user 383 ms, sys: 4.2 ms, total: 387 ms
    Wall time: 387 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f146527d8d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 663 μs, total: 123 ms
    Wall time: 122 ms
