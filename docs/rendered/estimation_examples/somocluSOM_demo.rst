...
.. parsed-literal::
    ...
    CPU times: user 8min 19s, sys: 780 ms, total: 8min 20s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa3801493c0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7464/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fa321ef9030>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fa321eac8e0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fa321e722c0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fa321e73d00>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7464/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fa322434850>
