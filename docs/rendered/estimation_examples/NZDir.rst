...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7c670fa050>
...
.. parsed-literal::
    ...
    CPU times: user 315 ms, sys: 7.8 ms, total: 322 ms
    Wall time: 322 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7c65943f10>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 119 ms, sys: 730 μs, total: 119 ms
    Wall time: 119 ms
