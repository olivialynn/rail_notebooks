...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5b1fe4aaa0>
...
.. parsed-literal::
    ...
    CPU times: user 302 ms, sys: 4.08 ms, total: 306 ms
    Wall time: 305 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f5b1be37190>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 105 ms, sys: 4.49 ms, total: 110 ms
    Wall time: 109 ms
