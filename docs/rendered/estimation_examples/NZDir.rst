...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fec3cfb7670>
...
.. parsed-literal::
    ...
    CPU times: user 305 ms, sys: 1.67 ms, total: 307 ms
    Wall time: 306 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fec3b2350f0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 106 ms, sys: 4.85 ms, total: 110 ms
    Wall time: 110 ms
