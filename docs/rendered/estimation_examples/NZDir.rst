...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb73265b5b0>
...
.. parsed-literal::
    ...
    CPU times: user 306 ms, sys: 3.82 ms, total: 310 ms
    Wall time: 308 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb72dc41390>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 109 ms, sys: 918 µs, total: 110 ms
    Wall time: 110 ms
