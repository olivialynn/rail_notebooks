...
`Goldenspike.ipynb <https://github.com/LSSTDESC/rail/blob/main/interactive_examples/goldenspike_examples/Goldenspike.ipynb>`__
in the ``interactive_examples/goldenspike_examples/`` folder for a
...
.. parsed-literal::
    ...
    Inserting handle into data store.  input: /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/base_catalog.pq, flow_modeler
...
.. parsed-literal::
    ...
    Inserting handle into data store.  model_flow_modeler: /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/inprogress_trained_flow.pkl, flow_modeler
...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7fe554ef22c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  model_flow_modeler: <class 'rail.tools.flow_handle.FlowHandle'> /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl, (wd), flow_creator_train
...
.. parsed-literal::
    ...
    Inserting handle into data store.  output_col_remapper_train: None, table_conv_train
...
.. parsed-literal::
    ...
    Inserting handle into data store.  model_flow_modeler: <class 'rail.tools.flow_handle.FlowHandle'> /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl, (wd), flow_creator_test
    Inserting handle into data store.  model_flow_modeler: <class 'rail.tools.flow_handle.FlowHandle'> /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl, (wd), flow_post_test
...
.. parsed-literal::
    ...
    best fit values are sigma=0.017222222222222222 and numneigh=5
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/site-packages/xgboost/training.py:200: UserWarning: [14:59:37] WARNING: /__w/xgboost/xgboost/src/learner.cc:782: 
    Parameters: { "silent" } are not used.
    
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/site-packages/xgboost/training.py:200: UserWarning: [14:59:38] WARNING: /__w/xgboost/xgboost/src/learner.cc:782: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/site-packages/xgboost/training.py:200: UserWarning: [14:59:42] WARNING: /__w/xgboost/xgboost/src/learner.cc:782: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    Best bump = 0.33263157894736844, best sharpen = 1.8
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.20/x64/lib/python3.10/site-packages/xgboost/training.py:200: UserWarning: [14:59:43] WARNING: /__w/xgboost/xgboost/src/learner.cc:782: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe4d8eb5ea0>
...
.. code:: ipython3
    ...
    estimate_fzboost = FlexZBoostEstimator.make_stage(
        ...
        hdf5_groupname="",
        aliases=dict(output="fzboost_estim"),
    )
...
.. parsed-literal::
    ...
    Inserting handle into data store.  output_table_conv_test: None, test_FZBoost
...
.. parsed-literal::
    ...
    Inserting handle into data store.  output_estimate_knn: None, knn_dist_to_point
    Inserting handle into data store.  truth: None, knn_dist_to_point
    Requested metrics: ['cdeloss', 'pit', 'brier']
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7fe4cc851750>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe4ccbf0190>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe4ccbf1030>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7fe4ccb45d20>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe4ccb44d00>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe4ccb45d80>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7fe4ccb47550>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe4ccb47ee0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe4ccb44370>}}
...
.. image:: Goldenspike_files/Goldenspike_44_0.png
...
.. image:: Goldenspike_files/Goldenspike_45_0.png
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7fe554e88220>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fe508b51f60>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fe4b8678520>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fe508b507f0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fe508b53c40>,
       <rail.creation.degraders.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7fe508b51ed0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.creation.degraders.spectroscopic_degraders.LineConfusion at 0x7fe508b51f00>,
       <rail.tools.table_tools.TableConverter at 0x7fe508b51150>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.tools.table_tools.TableConverter at 0x7fe508b50c40>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7fe4cc991090>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7fe4cc993970>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7fe4cc9935e0>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7fe4d8eb60e0>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7fe4d8eb4280>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7fe4d8eb4b80>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7fe4ccbf34f0>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7fe4ccbf2bf0>]),
...
.. parsed-literal::
    ...
    Inserting handle into data store.  model_flow_modeler: /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl, flow_creator_train
    Inserting handle into data store.  model_flow_modeler: /home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl, flow_creator_test
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1   python3 -m ceci rail.creation.engines.flowEngine.FlowModeler   --input=/home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/base_catalog.pq   --name=flow_modeler   --config=tmp_goldenspike_config.yml   --model=.//home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl 
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1   python3 -m ceci rail.creation.engines.flowEngine.FlowCreator   --model=.//home/runner/work/rail_notebooks/rail/pipeline_examples/goldenspike_examples/data/trained_flow.pkl   --name=flow_creator_train   --config=tmp_goldenspike_config.yml   --output=./output_flow_creator_train.pq 
