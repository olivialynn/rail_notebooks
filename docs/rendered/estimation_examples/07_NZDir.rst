...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbf1840f6a0>
...
.. parsed-literal::
    ...
    CPU times: user 293 ms, sys: 8.95 ms, total: 302 ms
    Wall time: 301 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fbf16deac20>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 127 ms, sys: 6 ms, total: 133 ms
    Wall time: 132 ms
