...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f7c12a7ee90>
...
.. parsed-literal::
    ...
    CPU times: user 531 ms, sys: 76.9 ms, total: 608 ms
    Wall time: 1.32 s
...
.. parsed-literal::
    ...
    CPU times: user 11.1 s, sys: 343 ms, total: 11.5 s
    Wall time: 11.1 s
...
.. parsed-literal::
    ...
    8.23 s ± 25.1 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.5 s, sys: 961 ms, total: 12.4 s
    Wall time: 12.1 s
...
.. parsed-literal::
    ...
    870 ms ± 3.78 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    40.4 ms ± 575 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
