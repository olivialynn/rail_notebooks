...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 809 ms, total: 8min 5s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f34a8ce5fc0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7336/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f344c2c37c0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f344c2ec400>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f344c436470>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f344c474130>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7336/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f344c44fc10>
