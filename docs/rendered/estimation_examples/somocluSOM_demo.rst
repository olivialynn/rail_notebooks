...
.. parsed-literal::
    ...
    CPU times: user 8min 19s, sys: 712 ms, total: 8min 19s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4c8c399ff0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7313/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f4c2e148df0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4c2e148f10>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f4c2e08b6a0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4c2e08aef0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7313/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f4c2e2b9360>
