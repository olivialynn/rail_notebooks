...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 536 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efc7846b0a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7efc0fe48f40>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efc19d47460>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7efc0c4b15d0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efc0c4b26b0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_6725/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efc07df8190>
