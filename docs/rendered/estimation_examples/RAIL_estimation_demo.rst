...
.. parsed-literal::
    ...
    CPU times: user 8.81 s, sys: 1.93 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faaa9057ee0>
...
.. parsed-literal::
    ...
    CPU times: user 49.6 s, sys: 10.4 s, total: 60 s
    Wall time: 1min 2s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faaeff12ce0>
