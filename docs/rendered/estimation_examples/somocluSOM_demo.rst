...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 725 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efe9414b850>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7188/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7efe3905b670>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efe390251e0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7efe38f92a10>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efe38f93e20>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7188/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7efe391911b0>
