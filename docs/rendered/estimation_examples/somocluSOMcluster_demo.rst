...
.. parsed-literal::
    ...
    CPU times: user 8min 24s, sys: 509 ms, total: 8min 25s
    Wall time: 2min 8s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f940c09a2c0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f93aa321ff0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f93a8250f10>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f93a1b62080>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f93a1b62c20>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7555/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f93a1b43b50>
