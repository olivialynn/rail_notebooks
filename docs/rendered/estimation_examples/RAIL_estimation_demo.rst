...
.. parsed-literal::
    ...
    CPU times: user 8.52 s, sys: 1.94 s, total: 10.5 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb0d25fc2e0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb0ab2627d0>
...
.. parsed-literal::
    ...
    CPU times: user 11.6 s, sys: 1.03 s, total: 12.6 s
    Wall time: 12.3 s
