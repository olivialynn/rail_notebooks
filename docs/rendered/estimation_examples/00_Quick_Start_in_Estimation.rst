...
.. parsed-literal::
    ...
    CPU times: user 8.28 s, sys: 1.89 s, total: 10.2 s
    Wall time: 10.2 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe17de97ee0>
...
.. parsed-literal::
    ...
    CPU times: user 56.3 s, sys: 814 ms, total: 57.1 s
    Wall time: 1min 8s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe17d89e830>
