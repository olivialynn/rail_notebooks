...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [06:56:47] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc8ab6efc40>
...
.. parsed-literal::
    ...
    CPU times: user 591 ms, sys: 58.8 ms, total: 650 ms
    Wall time: 1.33 s
...
.. parsed-literal::
    ...
    CPU times: user 8.87 s, sys: 298 ms, total: 9.17 s
    Wall time: 8.83 s
...
.. parsed-literal::
    ...
    8.1 s ± 10.6 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    868 ms ± 5.18 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 367 ms, sys: 63.4 ms, total: 431 ms
    Wall time: 431 ms
...
.. parsed-literal::
    ...
    40.3 ms ± 397 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
