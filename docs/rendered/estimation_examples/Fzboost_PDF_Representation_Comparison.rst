...
.. parsed-literal::
    ...
    CPU times: user 48.2 s, sys: 10.8 s, total: 58.9 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb1cc053a00>
...
.. parsed-literal::
    ...
    CPU times: user 537 ms, sys: 65.7 ms, total: 602 ms
    Wall time: 1.31 s
...
.. parsed-literal::
    ...
    CPU times: user 8.92 s, sys: 284 ms, total: 9.2 s
    Wall time: 8.85 s
...
.. parsed-literal::
    ...
    8.32 s ± 28.5 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.4 s, sys: 926 ms, total: 12.3 s
    Wall time: 12.1 s
...
.. parsed-literal::
    ...
    820 ms ± 2.74 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 375 ms, sys: 66.6 ms, total: 441 ms
    Wall time: 441 ms
...
.. parsed-literal::
    ...
    41.7 ms ± 624 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
