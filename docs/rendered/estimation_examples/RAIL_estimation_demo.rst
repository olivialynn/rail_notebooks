...
.. parsed-literal::
    ...
    CPU times: user 8.59 s, sys: 1.83 s, total: 10.4 s
    Wall time: 10.4 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd5c81d3010>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd55cb37f40>
...
.. parsed-literal::
    ...
    CPU times: user 11.4 s, sys: 963 ms, total: 12.3 s
    Wall time: 12 s
