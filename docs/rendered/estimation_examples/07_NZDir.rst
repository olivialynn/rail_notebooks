...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f89a3b2f6d0>
...
.. parsed-literal::
    ...
    CPU times: user 293 ms, sys: 5.99 ms, total: 299 ms
    Wall time: 298 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f89a25b61d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 129 ms, sys: 2.02 ms, total: 131 ms
    Wall time: 130 ms
