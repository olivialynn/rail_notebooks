...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7f65fd548d60>
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:04:29] WARNING: /workspace/src/learner.cc:738: 
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:04:30] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:04:33] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:04:34] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f65acdb3eb0>
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7f65acfe3340>,
      'summary': <rail.core.data.Hdf5Handle at 0x7f65acbebbb0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7f65acbeb460>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7f65acbe83d0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7f65acbe8a60>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7f65acbeb1f0>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7f65acbe9450>,
      'summary': <rail.core.data.Hdf5Handle at 0x7f65acbe9510>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7f65acbe8ee0>}}
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7f660ffc3160>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7f65e03d1810>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7f65e02053c0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7f65e03d0550>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7f65e03d3cd0>,
       <rail.creation.degraders.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7f65e03d1360>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.creation.degraders.spectroscopic_degraders.LineConfusion at 0x7f65e03d1480>,
       <rail.tools.table_tools.TableConverter at 0x7f65e03d39d0>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.tools.table_tools.TableConverter at 0x7f65e039b370>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7f65ac0f0850>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7f658cd4ffd0>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7f65e03d0970>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7f65c078ea40>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7f65c078ff10>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7f65c078c4f0>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7f65c078fe50>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7f65c078fa30>]),
