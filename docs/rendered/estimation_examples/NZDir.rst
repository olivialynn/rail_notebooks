...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd8c963afb0>
...
.. parsed-literal::
    ...
    CPU times: user 317 ms, sys: 8.18 ms, total: 325 ms
    Wall time: 324 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd8c5700c40>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 118 ms, sys: 7.6 ms, total: 126 ms
    Wall time: 125 ms
