...
.. parsed-literal::
    ...
    CPU times: user 49.2 s, sys: 10.8 s, total: 1min
    Wall time: 1min 1s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4781d23910>
...
.. parsed-literal::
    ...
    CPU times: user 531 ms, sys: 74.7 ms, total: 605 ms
    Wall time: 1.32 s
...
.. parsed-literal::
    ...
    CPU times: user 11.2 s, sys: 344 ms, total: 11.6 s
    Wall time: 11.2 s
...
.. parsed-literal::
    ...
    8.15 s ± 19.4 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 888 ms, total: 12.7 s
    Wall time: 12.4 s
...
.. parsed-literal::
    ...
    860 ms ± 5.15 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 360 ms, sys: 84.1 ms, total: 444 ms
    Wall time: 443 ms
...
.. parsed-literal::
    ...
    42 ms ± 517 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
