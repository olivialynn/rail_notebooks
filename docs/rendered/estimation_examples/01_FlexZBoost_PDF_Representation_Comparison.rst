...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.16/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [07:01:06] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 56.5 s, sys: 1.1 s, total: 57.6 s
    Wall time: 1min 6s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8cc2aef550>
...
.. parsed-literal::
    ...
    CPU times: user 569 ms, sys: 63.3 ms, total: 632 ms
    Wall time: 1.34 s
...
.. parsed-literal::
    ...
    CPU times: user 8.8 s, sys: 11.3 ms, total: 8.81 s
    Wall time: 8.5 s
...
.. parsed-literal::
    ...
    CPU times: user 10.8 s, sys: 42.6 ms, total: 10.8 s
    Wall time: 10.5 s
...
.. parsed-literal::
    ...
    7.92 s ± 55.1 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 12.1 s, sys: 167 ms, total: 12.3 s
    Wall time: 12 s
...
.. parsed-literal::
    ...
    863 ms ± 5.92 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 198 ms, sys: 73.3 ms, total: 271 ms
    Wall time: 271 ms
...
.. parsed-literal::
    ...
    36.4 ms ± 410 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
