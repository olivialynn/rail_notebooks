...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7fe9442a0760>
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:05:50] WARNING: /workspace/src/learner.cc:738: 
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:05:51] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:05:54] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:05:55] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe90804d300>
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7fe8fc4fdcc0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe8fcdeda50>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe8fcdef940>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7fe8fcdef5e0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe8fcdee6e0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe8fcdee440>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7fe8fcdef220>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fe8fcdee230>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fe8fcdec6a0>}}
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7fe956e17d00>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fe9302941f0>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fe8d8fa1540>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fe930294cd0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fe8d8fa0070>,
       <rail.creation.degraders.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7fe9a4f22fe0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.creation.degraders.spectroscopic_degraders.LineConfusion at 0x7fe930294520>,
       <rail.tools.table_tools.TableConverter at 0x7fe8d8fa1c60>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.tools.table_tools.TableConverter at 0x7fe93025b7f0>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7fe90804c730>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7fe90804fa60>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7fe90804f5e0>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7fe8fc1b4580>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7fe8fc1b6b30>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7fe8fc1b5420>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7fe8fcde2440>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7fe8fcde3820>]),
