...
.. parsed-literal::
    ...
    CPU times: user 8min 20s, sys: 743 ms, total: 8min 20s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2bf04cb160>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2b97f0cdc0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b97f41ab0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f2b8fb68d60>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b8fb695a0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7192/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f2b8c82b790>
