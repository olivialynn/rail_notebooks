...
.. parsed-literal::
    ...
    CPU times: user 8.97 s, sys: 2.06 s, total: 11 s
    Wall time: 11 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f403ebc1ba0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f403d4ef400>
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 12.2 s, sys: 959 ms, total: 13.2 s
    Wall time: 12.9 s
