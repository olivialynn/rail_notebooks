...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6a946838b0>
...
.. parsed-literal::
    ...
    CPU times: user 310 ms, sys: 1.12 ms, total: 311 ms
    Wall time: 310 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6a92382b30>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 113 ms, sys: 196 µs, total: 113 ms
    Wall time: 113 ms
