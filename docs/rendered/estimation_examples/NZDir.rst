...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc624f434c0>
...
.. parsed-literal::
    ...
    CPU times: user 294 ms, sys: 16.3 ms, total: 310 ms
    Wall time: 309 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc620357a60>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 105 ms, sys: 12.2 ms, total: 117 ms
    Wall time: 117 ms
