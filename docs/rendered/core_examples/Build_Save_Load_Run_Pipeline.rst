...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x7fd810406680>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7fd861776fb0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.utilStages.TableConverter at 0x7fd8104636a0>]),
