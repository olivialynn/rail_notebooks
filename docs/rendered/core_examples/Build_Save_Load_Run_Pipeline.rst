...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x7fb98112ed40>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7fb9e03e0e20>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7fb9807fd4e0>]),
