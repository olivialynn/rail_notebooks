...
.. parsed-literal::
    ...
    CPU times: user 8min 22s, sys: 893 ms, total: 8min 23s
    Wall time: 2min 8s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f01f8966350>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7337/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f019d58ebf0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f019d56c490>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f019db5a470>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f019d56c4f0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7337/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f019daefac0>
