...
.. parsed-literal::
    ...
    CPU times: user 9.63 s, sys: 2.26 s, total: 11.9 s
    Wall time: 11.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe6c76cbfd0>
...
.. parsed-literal::
    ...
    CPU times: user 50.1 s, sys: 10.3 s, total: 1min
    Wall time: 1min 2s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe6c60ab130>
