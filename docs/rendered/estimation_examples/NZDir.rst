...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd85460ece0>
...
.. parsed-literal::
    ...
    CPU times: user 293 ms, sys: 12.3 ms, total: 305 ms
    Wall time: 304 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd850663a00>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 813 µs, total: 111 ms
    Wall time: 110 ms
