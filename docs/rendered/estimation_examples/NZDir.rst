...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fecdfa0ae00>
...
.. parsed-literal::
    ...
    CPU times: user 317 ms, sys: 3.61 ms, total: 320 ms
    Wall time: 321 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fecde12b160>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 4.24 ms, total: 121 ms
    Wall time: 121 ms
