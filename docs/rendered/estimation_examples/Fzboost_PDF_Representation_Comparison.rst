...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      warnings.warn(smsg, UserWarning)
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:02:05] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
    ...
    Parameters: { "silent" } are not used.
      ...
      warnings.warn(smsg, UserWarning)
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:02:06] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      warnings.warn(smsg, UserWarning)
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:03:00] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 49.6 s, sys: 10.4 s, total: 1min
    Wall time: 1min 2s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa7ec987760>
...
.. parsed-literal::
    ...
    CPU times: user 551 ms, sys: 86.8 ms, total: 638 ms
    Wall time: 1.34 s
...
.. parsed-literal::
    ...
    CPU times: user 9.11 s, sys: 285 ms, total: 9.4 s
    Wall time: 9.05 s
...
.. parsed-literal::
    ...
    CPU times: user 11.2 s, sys: 347 ms, total: 11.5 s
    Wall time: 11.2 s
...
.. parsed-literal::
    ...
    8.38 s ± 22.9 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 977 ms, total: 12.8 s
    Wall time: 12.5 s
...
.. parsed-literal::
    ...
    856 ms ± 6.38 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 371 ms, sys: 75.9 ms, total: 447 ms
    Wall time: 449 ms
...
.. parsed-literal::
    ...
    41.1 ms ± 366 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
