...
.. parsed-literal::
    ...
    CPU times: user 9.01 s, sys: 1.97 s, total: 11 s
    Wall time: 11 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f12899f2dd0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f12882aafb0>
...
.. parsed-literal::
    ...
    CPU times: user 12.2 s, sys: 932 ms, total: 13.2 s
    Wall time: 12.9 s
