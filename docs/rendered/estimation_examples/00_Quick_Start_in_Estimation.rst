...
.. parsed-literal::
    ...
    CPU times: user 8.26 s, sys: 1.97 s, total: 10.2 s
    Wall time: 10.2 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f07fc0df6a0>
...
.. parsed-literal::
    ...
    CPU times: user 56.4 s, sys: 913 ms, total: 57.3 s
    Wall time: 1min 6s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f07a58fe920>
