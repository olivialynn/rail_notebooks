...
.. parsed-literal::
    ...
    CPU times: user 8.26 s, sys: 1.84 s, total: 10.1 s
    Wall time: 10.1 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6deddeb820>
...
.. parsed-literal::
    ...
    CPU times: user 56.7 s, sys: 887 ms, total: 57.6 s
    Wall time: 1min 6s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6dbd4ea380>
