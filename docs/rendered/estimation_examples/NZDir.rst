...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4cc92dca60>
...
.. parsed-literal::
    ...
    CPU times: user 310 ms, sys: 15.5 ms, total: 325 ms
    Wall time: 324 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4cc78fce80>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 115 ms, sys: 7.76 ms, total: 123 ms
    Wall time: 122 ms
