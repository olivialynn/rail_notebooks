...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efe3a543550>
...
.. parsed-literal::
    ...
    CPU times: user 312 ms, sys: 8.29 ms, total: 321 ms
    Wall time: 321 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7efe38d3fb20>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 122 ms, sys: 397 μs, total: 123 ms
    Wall time: 122 ms
