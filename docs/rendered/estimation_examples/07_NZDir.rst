...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe9ca0336d0>
...
.. parsed-literal::
    ...
    CPU times: user 344 ms, sys: 6.03 ms, total: 351 ms
    Wall time: 350 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe9c6588760>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 120 ms, sys: 3.01 ms, total: 123 ms
    Wall time: 123 ms
