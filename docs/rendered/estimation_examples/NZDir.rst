...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f0f4ef130d0>
...
.. parsed-literal::
    ...
    CPU times: user 314 ms, sys: 4.93 ms, total: 319 ms
    Wall time: 318 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f0f4d50fa00>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 1.79 ms, total: 119 ms
    Wall time: 119 ms
