...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe16742ee60>
...
.. parsed-literal::
    ...
    CPU times: user 284 ms, sys: 13 ms, total: 297 ms
    Wall time: 297 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe1660dab30>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 123 ms, sys: 2.96 ms, total: 126 ms
    Wall time: 126 ms
