...
.. parsed-literal::
    ...
    CPU times: user 8.89 s, sys: 2 s, total: 10.9 s
    Wall time: 10.9 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f20f01771f0>
...
.. parsed-literal::
    ...
    CPU times: user 46.9 s, sys: 10.5 s, total: 57.4 s
    Wall time: 59.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f20e0b465f0>
