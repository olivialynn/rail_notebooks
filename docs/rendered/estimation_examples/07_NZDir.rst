...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fac40071d20>
...
.. parsed-literal::
    ...
    CPU times: user 292 ms, sys: 4.01 ms, total: 296 ms
    Wall time: 296 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fac3c0ed2a0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 976 μs, total: 127 ms
    Wall time: 126 ms
