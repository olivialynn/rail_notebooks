...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f85bd41ea70>
...
.. parsed-literal::
    ...
    CPU times: user 288 ms, sys: 7.81 ms, total: 296 ms
    Wall time: 295 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f85bbd2fdc0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 126 ms, sys: 4 ms, total: 130 ms
    Wall time: 130 ms
