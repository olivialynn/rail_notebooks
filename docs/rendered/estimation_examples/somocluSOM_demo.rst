...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 737 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f07ace60eb0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7158/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f076141ffa0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f07639c8640>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f07639fe560>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f0763a33fd0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7158/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f0760eb8550>
