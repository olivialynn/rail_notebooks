...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa0de2f1960>
...
.. parsed-literal::
    ...
    CPU times: user 314 ms, sys: 214 μs, total: 314 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa0d9afffd0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 113 ms, sys: 4.39 ms, total: 117 ms
    Wall time: 117 ms
