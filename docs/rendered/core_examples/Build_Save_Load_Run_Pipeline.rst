...
.. parsed-literal::
    ...
    (({'flow_engine_test': <Job flow_engine_test>,
      ...
      [<rail.creation.engines.flowEngine.FlowCreator at 0x7f5ce8d3b0d0>,
       <rail.creation.degradation.lsst_error_model.LSSTErrorModel at 0x7f5d40f67190>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.core.util_stages.TableConverter at 0x7f5ce8de96c0>]),
