...
.. parsed-literal::
    ...
    CPU times: user 8min 4s, sys: 854 ms, total: 8min 5s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff188a564a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff133298df0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff12a9e5180>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7ff12ac36860>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff12ac9dd50>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_14289/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff1338e9630>
