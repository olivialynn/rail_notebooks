...
.. parsed-literal::
    ...
    CPU times: user 8min 3s, sys: 784 ms, total: 8min 4s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fb948b2e860>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fb8f13cf310>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fb8e89633a0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fb8e816d030>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fb8f1859d20>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_15781/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fb8e8107b80>
