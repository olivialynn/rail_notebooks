...
.. parsed-literal::
    ...
    (({'NZDirInformer': <Job NZDirInformer>,
      ...
      [<rail.estimation.algos.nz_dir.NZDirInformer at 0x7ff17c68d8d0>,
       <rail.estimation.algos.nz_dir.NZDirSummarizer at 0x7ff1248fceb0>]),
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1   python3 -m ceci rail.estimation.algos.nz_dir.NZDirInformer   --input=/opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/rail/examples_data/testdata/test_dc2_training_9816.hdf5   --config=nzdir_config.yml   --model=./nzdir_model.pkl 
...
.. parsed-literal::
    ...
    Command is:
    OMP_NUM_THREADS=1  mpirun -n 2 python3 -m ceci rail.estimation.algos.nz_dir.NZDirSummarizer   --model=./nzdir_model.pkl   --input=/opt/hostedtoolcache/Python/3.10.15/x64/lib/python3.10/site-packages/rail/examples_data/testdata/test_dc2_validation_9816.hdf5   --config=nzdir_config.yml   --output=./NZDir_samples.hdf5   --single_NZ=./NZDir_NZ.hdf5 --mpi
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7ff1225c1b10>
