...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc4fdd9f520>
...
.. parsed-literal::
    ...
    CPU times: user 347 ms, sys: 4.97 ms, total: 352 ms
    Wall time: 353 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fc4fc55b5b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 115 ms, sys: 1.95 ms, total: 117 ms
    Wall time: 116 ms
