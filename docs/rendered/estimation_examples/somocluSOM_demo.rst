...
.. parsed-literal::
    ...
    CPU times: user 8min 24s, sys: 684 ms, total: 8min 24s
    Wall time: 2min 8s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6b7d9d3df0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7315/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f6b74a27640>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f6b7ce2c3d0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f6b7ce3abf0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f6b7ce28460>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7315/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f6b7a800dc0>
