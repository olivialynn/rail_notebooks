...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe722257df0>
...
.. parsed-literal::
    ...
    CPU times: user 306 ms, sys: 6.82 ms, total: 313 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fe778aab5b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 114 ms, sys: 3.2 ms, total: 118 ms
    Wall time: 117 ms
