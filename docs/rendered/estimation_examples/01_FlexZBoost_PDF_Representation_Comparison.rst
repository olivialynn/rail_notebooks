...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.17/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [07:01:41] WARNING: /workspace/src/learner.cc:738: 
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.17/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [07:01:42] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.17/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [07:02:37] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    CPU times: user 57.1 s, sys: 1.01 s, total: 58.2 s
    Wall time: 1min 6s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f38286bc7c0>
...
.. parsed-literal::
    ...
    CPU times: user 633 ms, sys: 65 ms, total: 698 ms
    Wall time: 1.38 s
...
.. parsed-literal::
    ...
    CPU times: user 8.96 s, sys: 14.2 ms, total: 8.97 s
    Wall time: 8.63 s
...
.. parsed-literal::
    ...
    CPU times: user 11 s, sys: 45.6 ms, total: 11.1 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    8.04 s ± 74.3 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    872 ms ± 5.83 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 198 ms, sys: 84.4 ms, total: 282 ms
    Wall time: 283 ms
...
.. parsed-literal::
    ...
    37.6 ms ± 480 μs per loop (mean ± std. dev. of 7 runs, 10 loops each)
