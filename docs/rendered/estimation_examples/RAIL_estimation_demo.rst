...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff1d81e33a0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff1cec85480>
...
.. parsed-literal::
    ...
    CPU times: user 152 µs, sys: 34 µs, total: 186 µs
    Wall time: 191 µs
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 11.6 s, sys: 993 ms, total: 12.5 s
    Wall time: 12.2 s
