...
.. parsed-literal::
    ...
    CPU times: user 8min 19s, sys: 939 ms, total: 8min 20s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fce8c6e3400>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7279/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fce29b8e6e0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fce29be88e0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7fce29c223b0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fce29c22e30>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7279/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fce29c587c0>
