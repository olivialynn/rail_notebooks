...
.. parsed-literal::
    ...
    <rail.tools.flow_handle.FlowHandle at 0x7fa3a8688760>
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:09:11] WARNING: /workspace/src/learner.cc:738: 
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:09:12] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:09:15] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    Parameters: { "silent" } are not used.
      ...
      bst.update(dtrain, iteration=i, fobj=obj)
    /opt/hostedtoolcache/Python/3.10.18/x64/lib/python3.10/site-packages/xgboost/training.py:183: UserWarning: [08:09:16] WARNING: /workspace/src/learner.cc:738: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa3bb21b4c0>
...
.. parsed-literal::
    ...
    {'bpz': {'output': <rail.core.data.Hdf5Handle at 0x7fa3603d1870>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fa36c379c60>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fa36c37b760>},
     'fzboost': {'output': <rail.core.data.Hdf5Handle at 0x7fa36c37a6e0>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fa36c37a6b0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fa36c378a90>},
     'knn': {'output': <rail.core.data.Hdf5Handle at 0x7fa36c379a20>,
      'summary': <rail.core.data.Hdf5Handle at 0x7fa36c37a1a0>,
      'single_distribution_summary': <rail.core.data.QPDictHandle at 0x7fa36c37a890>}}
...
.. parsed-literal::
    ...
    (({'flow_modeler': <Job flow_modeler>,
      ...
      [<rail.creation.engines.flowEngine.FlowModeler at 0x7fa3bb21abf0>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fa3946855a0>,
       <rail.creation.engines.flowEngine.FlowCreator at 0x7fa34c316bc0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fa3946842e0>,
       <rail.creation.degraders.photometric_errors.LSSTErrorModel at 0x7fa394686200>,
       <rail.creation.degraders.spectroscopic_degraders.InvRedshiftIncompleteness at 0x7fa3946850f0>,
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.creation.degraders.spectroscopic_degraders.LineConfusion at 0x7fa3946843d0>,
       <rail.tools.table_tools.TableConverter at 0x7fa394685210>,
       Degrader that applies the following cuts to a pandas DataFrame:
       {column: (min, max), ...}
       {'mag_i_lsst': (-inf, 25.0)},
       Stage that applies remaps the following column names in a pandas DataFrame:
       f{str(self.config.columns)},
       <rail.tools.table_tools.TableConverter at 0x7fa39464b7f0>,
       <rail.estimation.algos.bpz_lite.BPZliteInformer at 0x7fa3603d1330>,
       <rail.estimation.algos.k_nearneigh.KNearNeighInformer at 0x7fa3603d1420>,
       <rail.estimation.algos.flexzboost.FlexZBoostInformer at 0x7fa3603d30d0>,
       <rail.estimation.algos.bpz_lite.BPZliteEstimator at 0x7fa3605b3850>,
       <rail.estimation.algos.k_nearneigh.KNearNeighEstimator at 0x7fa3605b0f10>,
       <rail.estimation.algos.flexzboost.FlexZBoostEstimator at 0x7fa3605b12d0>,
       <rail.estimation.algos.point_est_hist.PointEstHistSummarizer at 0x7fa36c1ee350>,
       <rail.estimation.algos.naive_stack.NaiveStackSummarizer at 0x7fa36c1ec280>]),
...
.. parsed-literal::
    ...
    Job flow_modeler has completed successfully in 1 minutes, 33.1 seconds
