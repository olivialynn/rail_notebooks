...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 986 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f055588b400>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7224/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f0551b98130>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f0551b98fd0>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f0547e96b60>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f0547e965f0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7224/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f054c7f0fd0>
