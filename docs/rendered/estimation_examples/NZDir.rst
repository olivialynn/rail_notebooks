...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6b60a434c0>
...
.. parsed-literal::
    ...
    CPU times: user 306 ms, sys: 8.27 ms, total: 314 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6b5d0832e0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 113 ms, sys: 4.02 ms, total: 117 ms
    Wall time: 116 ms
