...
.. parsed-literal::
    ...
    CPU times: user 9 s, sys: 2.06 s, total: 11.1 s
    Wall time: 11.1 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88a1757760>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f88a11deb00>
...
.. parsed-literal::
    ...
    CPU times: user 12.3 s, sys: 927 ms, total: 13.2 s
    Wall time: 12.9 s
