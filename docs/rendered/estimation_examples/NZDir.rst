...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4cb66acc70>
...
.. parsed-literal::
    ...
    CPU times: user 308 ms, sys: 4.31 ms, total: 313 ms
    Wall time: 312 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f4cb2b83100>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 108 ms, sys: 8.15 ms, total: 117 ms
    Wall time: 116 ms
