...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fea5b8dbdc0>
...
.. parsed-literal::
    ...
    CPU times: user 297 ms, sys: 3.9 ms, total: 301 ms
    Wall time: 300 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fea578e5de0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 127 ms, sys: 1.98 ms, total: 129 ms
    Wall time: 128 ms
