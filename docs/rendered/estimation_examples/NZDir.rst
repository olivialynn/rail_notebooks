...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f43cd96fac0>
...
.. parsed-literal::
    ...
    CPU times: user 351 ms, sys: 4.95 ms, total: 356 ms
    Wall time: 355 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f43cbcd76d0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 121 ms, sys: 3 ms, total: 124 ms
    Wall time: 124 ms
