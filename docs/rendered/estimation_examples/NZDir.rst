...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2327ed3fd0>
...
.. parsed-literal::
    ...
    CPU times: user 350 ms, sys: 7.58 ms, total: 358 ms
    Wall time: 359 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f2323eec4c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 124 ms, sys: 7.95 ms, total: 131 ms
    Wall time: 131 ms
