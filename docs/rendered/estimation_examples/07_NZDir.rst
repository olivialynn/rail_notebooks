...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff660ff6920>
...
.. parsed-literal::
    ...
    CPU times: user 285 ms, sys: 8.96 ms, total: 294 ms
    Wall time: 294 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ff64ee7afb0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 125 ms, sys: 1.98 ms, total: 127 ms
    Wall time: 127 ms
