...
.. parsed-literal::
    ...
    CPU times: user 8.74 s, sys: 1.82 s, total: 10.6 s
    Wall time: 10.6 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f726b702fb0>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f726b18b5b0>
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 11.8 s, sys: 882 ms, total: 12.7 s
    Wall time: 12.4 s
