...
.. parsed-literal::
    ...
    CPU times: user 8min 18s, sys: 1.02 s, total: 8min 19s
    Wall time: 2min 7s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f63889c08b0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7264/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f632bc876a0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f632bc3c400>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f632bc72b30>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f63889c2140>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7264/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f632bab4ca0>
