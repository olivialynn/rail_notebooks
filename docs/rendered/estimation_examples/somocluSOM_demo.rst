...
.. parsed-literal::
    ...
    CPU times: user 8min 6s, sys: 749 ms, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f83a4d0bca0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7380/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f83578dfd30>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f8357d8c490>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f8357dae290>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f8357daed40>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7380/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f835a49b970>
