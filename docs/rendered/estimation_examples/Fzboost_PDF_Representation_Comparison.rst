...
.. parsed-literal::
    ...
    CPU times: user 49.7 s, sys: 10.6 s, total: 1min
    Wall time: 1min 2s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f36235b3790>
...
.. parsed-literal::
    ...
    CPU times: user 636 ms, sys: 95.1 ms, total: 731 ms
    Wall time: 1.42 s
...
.. parsed-literal::
    ...
    CPU times: user 9.05 s, sys: 270 ms, total: 9.32 s
    Wall time: 8.98 s
...
.. parsed-literal::
    ...
    CPU times: user 11.2 s, sys: 349 ms, total: 11.6 s
    Wall time: 11.2 s
...
.. parsed-literal::
    ...
    8.3 s ± 22.4 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 993 ms, total: 12.7 s
    Wall time: 12.4 s
...
.. parsed-literal::
    ...
    873 ms ± 9.13 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 393 ms, sys: 71.8 ms, total: 464 ms
    Wall time: 464 ms
...
.. parsed-literal::
    ...
    41.3 ms ± 400 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
