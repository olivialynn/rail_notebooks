...
.. parsed-literal::
    ...
    CPU times: user 8.75 s, sys: 1.92 s, total: 10.7 s
    Wall time: 10.7 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6e476de860>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6e47626680>
...
.. parsed-literal::
    ...
    CPU times: user 12.1 s, sys: 933 ms, total: 13.1 s
    Wall time: 12.8 s
