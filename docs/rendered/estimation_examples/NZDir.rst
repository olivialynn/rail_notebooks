...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1bedef3010>
...
.. parsed-literal::
    ...
    CPU times: user 313 ms, sys: 54 μs, total: 313 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f1be9fb19c0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 110 ms, sys: 8.39 ms, total: 118 ms
    Wall time: 118 ms
