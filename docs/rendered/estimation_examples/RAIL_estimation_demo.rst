...
.. parsed-literal::
    ...
    CPU times: user 14.2 s, sys: 4.62 s, total: 18.8 s
    Wall time: 18.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcc3988fee0>
...
.. parsed-literal::
    ...
    CPU times: user 57 s, sys: 2.35 s, total: 59.3 s
    Wall time: 2min 3s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fcc3936b850>
