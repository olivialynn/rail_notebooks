...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f722d5bab90>
...
.. parsed-literal::
    ...
    CPU times: user 352 ms, sys: 5.96 ms, total: 358 ms
    Wall time: 358 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f722bbc75b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 125 ms, sys: 3 μs, total: 125 ms
    Wall time: 125 ms
