...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdf5ab3aaa0>
...
.. parsed-literal::
    ...
    CPU times: user 309 ms, sys: 8.11 ms, total: 317 ms
    Wall time: 316 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdfac59d450>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 121 ms, sys: 217 µs, total: 121 ms
    Wall time: 121 ms
