...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f13ac613670>
...
.. parsed-literal::
    ...
    CPU times: user 311 ms, sys: 27 µs, total: 311 ms
    Wall time: 310 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f13a7f520b0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 112 ms, sys: 268 µs, total: 112 ms
    Wall time: 112 ms
