...
.. parsed-literal::
    ...
    CPU times: user 9.05 s, sys: 2.06 s, total: 11.1 s
    Wall time: 11.1 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdbe2d8c400>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fdbe3326d40>
...
.. parsed-literal::
    ...
    CPU times: user 11.9 s, sys: 926 ms, total: 12.9 s
    Wall time: 12.6 s
