...
.. parsed-literal::
    ...
    CPU times: user 8.51 s, sys: 1.75 s, total: 10.3 s
    Wall time: 10.3 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f86d13027a0>
...
.. parsed-literal::
    ...
    CPU times: user 46.9 s, sys: 10.4 s, total: 57.3 s
    Wall time: 59.2 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f8684bae6b0>
