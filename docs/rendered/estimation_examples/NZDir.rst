...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fae764affd0>
...
.. parsed-literal::
    ...
    CPU times: user 313 ms, sys: 3.09 ms, total: 316 ms
    Wall time: 315 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fae74f16560>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 109 ms, sys: 326 µs, total: 110 ms
    Wall time: 109 ms
