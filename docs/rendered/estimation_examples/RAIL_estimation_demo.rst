...
.. parsed-literal::
    ...
    CPU times: user 14.6 s, sys: 5.19 s, total: 19.8 s
    Wall time: 19.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd80b3e93f0>
...
.. parsed-literal::
    ...
    CPU times: user 1min 8s, sys: 2.88 s, total: 1min 11s
    Wall time: 2min 27s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fd80887c0a0>
...
.. parsed-literal::
    ...
    CPU times: user 278 µs, sys: 30 µs, total: 308 µs
    Wall time: 312 µs
...
.. parsed-literal::
    ...
    Process 0 running estimator on chunk 20000 - 20449
    Process 0 estimating PZ PDF for rows 20,000 - 20,449
    CPU times: user 18 s, sys: 345 ms, total: 18.3 s
    Wall time: 19.4 s
