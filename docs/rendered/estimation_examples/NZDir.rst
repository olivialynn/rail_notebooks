...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f36819f6e00>
...
.. parsed-literal::
    ...
    CPU times: user 305 ms, sys: 9.51 ms, total: 314 ms
    Wall time: 313 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f36d7d4e080>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 116 ms, sys: 381 µs, total: 117 ms
    Wall time: 116 ms
