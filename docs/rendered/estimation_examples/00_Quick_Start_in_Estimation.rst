...
.. parsed-literal::
    ...
    CPU times: user 7.91 s, sys: 1.84 s, total: 9.75 s
    Wall time: 9.75 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3f0810fbb0>
...
.. parsed-literal::
    ...
    CPU times: user 55.3 s, sys: 795 ms, total: 56.1 s
    Wall time: 1min 6s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f3ef794bdc0>
