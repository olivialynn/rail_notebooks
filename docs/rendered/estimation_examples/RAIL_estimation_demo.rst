...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa6f7f52680>
...
.. parsed-literal::
    ...
    CPU times: user 48.1 s, sys: 10.5 s, total: 58.5 s
    Wall time: 1min
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7fa6783914b0>
...
.. parsed-literal::
    ...
    CPU times: user 11.8 s, sys: 1.04 s, total: 12.9 s
    Wall time: 12.6 s
