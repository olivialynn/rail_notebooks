...
.. parsed-literal::
    ...
    CPU times: user 8.9 s, sys: 1.94 s, total: 10.8 s
    Wall time: 10.8 s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f56cce0a800>
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f566cc65db0>
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 999 ms, total: 12.7 s
    Wall time: 12.3 s
