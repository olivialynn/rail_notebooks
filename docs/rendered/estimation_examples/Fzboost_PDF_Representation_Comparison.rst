...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:04:53] WARNING: /workspace/src/learner.cc:742: 
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:04:54] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    /opt/hostedtoolcache/Python/3.10.13/x64/lib/python3.10/site-packages/xgboost/core.py:160: UserWarning: [07:04:55] WARNING: /workspace/src/learner.cc:742: 
    Parameters: { "silent" } are not used.
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7ee75cdaba90>
...
.. parsed-literal::
    ...
    CPU times: user 8.88 s, sys: 292 ms, total: 9.17 s
    Wall time: 8.82 s
...
.. parsed-literal::
    ...
    CPU times: user 11 s, sys: 304 ms, total: 11.3 s
    Wall time: 10.9 s
...
.. parsed-literal::
    ...
    8.19 s ± 31.8 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 11.7 s, sys: 915 ms, total: 12.6 s
    Wall time: 12.3 s
...
.. parsed-literal::
    ...
    858 ms ± 4.55 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    CPU times: user 367 ms, sys: 68 ms, total: 435 ms
    Wall time: 435 ms
...
.. parsed-literal::
    ...
    41.6 ms ± 516 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
