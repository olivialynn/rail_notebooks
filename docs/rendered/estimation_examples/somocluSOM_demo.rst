...
.. parsed-literal::
    ...
    CPU times: user 8min 5s, sys: 1.16 s, total: 8min 6s
    Wall time: 2min 4s
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f6050d0b7f0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7325/3421861057.py:8: RuntimeWarning: invalid value encountered in divide
      meanszs /= cellocc
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f603aa2fbb0>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f60341c4790>
...
.. parsed-literal::
    ...
    <rail.core.data.QPHandle at 0x7f6034171d80>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f60341727d0>
...
.. parsed-literal::
    ...
    /tmp/ipykernel_7325/4031386170.py:5: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax.legend(loc='upper right', fontsize=13);
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7f60345a44c0>
