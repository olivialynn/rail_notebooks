...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faa68aff400>
...
.. parsed-literal::
    ...
    CPU times: user 353 ms, sys: 5.85 ms, total: 358 ms
    Wall time: 358 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7faa67382530>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 111 ms, sys: 6.99 ms, total: 118 ms
    Wall time: 118 ms
