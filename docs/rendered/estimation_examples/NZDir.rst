...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f40087cacb0>
...
.. parsed-literal::
    ...
    CPU times: user 310 ms, sys: 4.63 ms, total: 315 ms
    Wall time: 315 ms
...
.. parsed-literal::
    ...
    <rail.core.data.ModelHandle at 0x7f40070b7cd0>
...
.. parsed-literal::
    ...
    Inserting handle into data store.  single_NZ_nzsumm_hi: inprogress_single_NZ_nzsumm_hi.hdf5, nzsumm_hi
    Inserting handle into data store.  output_nzsumm_hi: inprogress_output_nzsumm_hi.hdf5, nzsumm_hi
    CPU times: user 117 ms, sys: 156 μs, total: 117 ms
    Wall time: 116 ms
